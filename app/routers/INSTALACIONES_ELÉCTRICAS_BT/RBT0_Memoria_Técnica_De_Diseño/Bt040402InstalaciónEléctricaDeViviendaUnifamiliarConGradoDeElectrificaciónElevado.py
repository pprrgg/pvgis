...
@router.post("/Bt040402")
def Bt040402InstalaciónEléctricaDeViviendaUnifamiliarConGradoDeElectrificaciónElevado(
    data: dict,
):
...
class comun:
    class main:
        ...
        def replaceLatex(pp, uu, vv, xx, yy, zz):
            ...
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                if 1:
                    ...
                    for var_name, value in pp.__dict__.items():
                        # print(f"pp.{var_name}")
                        contenido = contenido.replace(f"pp.{var_name}",f"{str(value)}",)
                    for var_name, value in uu.__dict__.items():
                        # print(f"uu.{var_name}")
        ...
        def xlsxhojaconvalorespordefecto():
            """ """
            print(
                f"\n {100*'+'} { __class__.__name__}.{sys._getframe().f_code.co_name}"
            )
            ...
            if 1:
                ...
                if not os.path.exists(ruta_archivo_excel):
                    ...
                    for i, (parametro, valor) in enumerate(
                        zip(df["Parámetro"], df["Valor"]), start=2
                    ):
                    ...
                    # para agregar la hoja de los Coordenadas

                    if "Coordenadas" not in sheet_names:
                        sheet2 = libro.create_sheet(title="Coordenadas")
                        sheet2.append(["Parámetro", "Valor"])
                        sheet2.append(["lat", 36.6641681434112])
                        sheet2.append(["lng", -4.45863940137516])

                    # para agregar la hoja de los participantes

                    if "Participantes" not in sheet_names:
                        sheet3 = libro.create_sheet(title="Participantes")
                        sheet3.append(["Parámetro", "P1", "P2", "P3"])
                        sheet3.append(
                            [
                                "Rol",
                                ";Autor;Promotor;Instalador",
                                " ;Autor;Promotor;Instalador",
                                " ;Autor;Promotor;Instalador",
                            ]
                        )
                        sheet3.append(["DNI/NIF/NIE", " ", " ", " "])
                        sheet3.append(["Nombre/Razón Social", " ", " ", " "])
                        sheet3.append(["Titulación", " ", " ", " "])
                        sheet3.append(["Dirección", " ", " ", " "])
                        sheet3.append(["Población", " ", " ", " "])
                        sheet3.append(["Teléfono", " ", " ", " "])
                        sheet3.append(["Correo Electrónico", " ", " ", " "])
...
if __name__ == "__main__":
    ...
    data = comun.main.xlsxhojaconvalorespordefecto()
