...
\begin{itemize}
    \item \textbf{Reglamento Electrotécnico para Baja Tensión (REBT)}:GUÍA-BT-22PROTECCIÓN CONTRA SOBREINTENSIDADES \url{https://industria.gob.es/Calidad-Industrial/seguridadindustrial/instalacionesindustriales/baja-tension/Documents/bt/guia_bt_22_oct05R1.pdf}
\end{itemize}
...
@router.post("/Bt220")
def Bt220ProtecciónContraSobreintensidades(
    data: dict,
):
