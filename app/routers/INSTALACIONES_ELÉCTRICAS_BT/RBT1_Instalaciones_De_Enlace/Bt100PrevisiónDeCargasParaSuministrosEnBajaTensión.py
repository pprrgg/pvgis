...
- Ubicación: [Dirección]\\
- Objeto del Proyecto: Diseño y ejecución de la instalación eléctrica en baja tensión.
...
Este proyecto se realiza conforme a lo establecido en:
- Reglamento Electrotécnico de Baja Tensión (REBT).
- ITC-BT-04.
- Normas UNE y normativa vigente.
...
Se detallan los sistemas eléctricos, alimentación, cuadros de distribución, protecciones, etc.
...
\section{CÁLCULOS JUSTIFICATIVOS}
\section{Cálculo de Cargas}
\begin{equation}
P = \sum P_i \cdot F.D.
\end{equation}
Donde $P_i$ es la potencia de cada receptor y $F.D.$ es el factor de demanda.

\section{Dimensionamiento de Conductores}
El cálculo de conductores se realiza según:
\begin{equation}
S = \frac{I}{J_{adm}}
\end{equation}
Siendo $S$ la sección, $I$ la corriente y $J_{adm}$ la densidad admisible.




\section{PLANOS}
Incluyen esquemas unifilares, planos de distribución y detalle de cuadros eléctricos.
...
\section{PRESUPUESTO}
Se presentan partidas detalladas con materiales y mano de obra.
...
\section{ESTUDIO DE SEGURIDAD Y SALUD}
Medidas de prevención y seguridad en la instalación eléctrica.
...
\begin{itemize}
    \item { \href{https://industria.gob.es/Calidad-Industrial/seguridadindustrial/instalacionesindustriales/baja-tension/Documents/bt/guia_bt_04_sep03R1.pdf}{Reglamento Electrotécnico para Baja Tensión (REBT)}: GUÍA-BT-04 DOCUMENTACIÓN Y PUESTA EN SERVICIO DE LAS INSTALACIONES}
\end{itemize}
...
@router.post("/Bt100")
def Bt100PrevisiónDeCargasParaSuministrosEnBajaTensión(
    data: dict,
):
