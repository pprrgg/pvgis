...
@router.post('/Etv020')
def Etv020InstalaciónDeInfraestructuraDeRecargaDelVehículoEléctrico(data: dict):
    ...
    ss.nombre = "Etv020InstalaciónDeInfraestructuraDeRecargaDelVehículoEléctrico"
    ss.path = f"app/routers/EFICIENCIA_ENERGETICA/Transporte/Etv020InstalaciónDeInfraestructuraDeRecargaDelVehículoEléctrico.pdf"
