...
@router.post('/Vea010')
def Vea010CambioDeCocheDeGasolinaAUnVehículoEléctrico(data: dict):
    ...
    ss.nombre = "Vea010CambioDeCocheDeGasolinaAUnVehículoEléctrico"
    ss.path = f"app/routers/EFICIENCIA_ENERGETICA/Transporte/Vea010CambioDeCocheDeGasolinaAUnVehículoEléctrico.pdf"
