...
@router.post('/Res060anexovi')
def Res060anexoviCondicionesConsideradasEnAcs(data: dict):
    ...
    ss.nombre = "Res060anexoviCondicionesConsideradasEnAcs"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res060anexoviCondicionesConsideradasEnAcs.pdf"
