...
@router.post('/Res060')
def Res060SustituciónDeCalderaDeCombustiónPorUnaBombaDeCalorDeAccionamientoEléctrico(data: dict):
    ...
    ss.nombre = "Res060SustituciónDeCalderaDeCombustiónPorUnaBombaDeCalorDeAccionamientoEléctrico"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res060SustituciónDeCalderaDeCombustiónPorUnaBombaDeCalorDeAccionamientoEléctrico.pdf"
