...
@router.post('/Res095anexoii')
def Res095anexoiiFórmulasParaObtenerLosCoeficientesDe(data: dict):
    ...
    ss.nombre = "Res095anexoiiFórmulasParaObtenerLosCoeficientesDe"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res095anexoiiFórmulasParaObtenerLosCoeficientesDe.pdf"
