...
@router.post('/Res020anexoii')
def Res020anexoiiValoresDelCoeficienteGSegúnZonaClimática(data: dict):
    ...
    ss.nombre = "Res020anexoiiValoresDelCoeficienteGSegúnZonaClimática"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res020anexoiiValoresDelCoeficienteGSegúnZonaClimática.pdf"
