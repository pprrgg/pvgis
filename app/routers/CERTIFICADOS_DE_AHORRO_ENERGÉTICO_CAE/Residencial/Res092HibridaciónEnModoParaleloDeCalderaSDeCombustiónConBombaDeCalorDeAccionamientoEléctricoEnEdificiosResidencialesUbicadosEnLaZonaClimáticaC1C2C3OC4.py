...
@router.post('/Res092')
def Res092HibridaciónEnModoParaleloDeCalderaSDeCombustiónConBombaDeCalorDeAccionamientoEléctricoEnEdificiosResidencialesUbicadosEnLaZonaClimáticaC1C2C3OC4(data: dict):
    ...
    ss.nombre = "Res092HibridaciónEnModoParaleloDeCalderaSDeCombustiónConBombaDeCalorDeAccionamientoEléctricoEnEdificiosResidencialesUbicadosEnLaZonaClimáticaC1C2C3OC4"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res092HibridaciónEnModoParaleloDeCalderaSDeCombustiónConBombaDeCalorDeAccionamientoEléctricoEnEdificiosResidencialesUbicadosEnLaZonaClimáticaC1C2C3OC4.pdf"
