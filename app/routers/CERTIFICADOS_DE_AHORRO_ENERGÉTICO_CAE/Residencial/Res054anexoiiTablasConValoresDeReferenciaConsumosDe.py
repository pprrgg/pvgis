...
@router.post('/Res054anexoii')
def Res054anexoiiTablasConValoresDeReferenciaConsumosDe(data: dict):
    ...
    ss.nombre = "Res054anexoiiTablasConValoresDeReferenciaConsumosDe"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res054anexoiiTablasConValoresDeReferenciaConsumosDe.pdf"
