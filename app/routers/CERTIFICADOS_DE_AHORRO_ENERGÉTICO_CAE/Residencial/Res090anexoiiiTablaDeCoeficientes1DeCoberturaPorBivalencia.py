...
@router.post('/Res090anexoiii')
def Res090anexoiiiTablaDeCoeficientes1DeCoberturaPorBivalencia(data: dict):
    ...
    ss.nombre = "Res090anexoiiiTablaDeCoeficientes1DeCoberturaPorBivalencia"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res090anexoiiiTablaDeCoeficientes1DeCoberturaPorBivalencia.pdf"
