...
@router.post('/Res020')
def Res020RehabilitaciónDeLaParteOpacaDeLaEnvolventeTérmicaDeEdificiosDeViviendasConSuperficieAfectadaInferiorOIgualAl25PorCientoDeLaEnvolventeTérmicaFinal(data: dict):
    ...
    ss.nombre = "Res020RehabilitaciónDeLaParteOpacaDeLaEnvolventeTérmicaDeEdificiosDeViviendasConSuperficieAfectadaInferiorOIgualAl25PorCientoDeLaEnvolventeTérmicaFinal"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res020RehabilitaciónDeLaParteOpacaDeLaEnvolventeTérmicaDeEdificiosDeViviendasConSuperficieAfectadaInferiorOIgualAl25PorCientoDeLaEnvolventeTérmicaFinal.pdf"
