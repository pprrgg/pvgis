...
@router.post('/Res090anexoii')
def Res090anexoiiFórmulasParaObtenerLosCoeficientesDe(data: dict):
    ...
    ss.nombre = "Res090anexoiiFórmulasParaObtenerLosCoeficientesDe"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res090anexoiiFórmulasParaObtenerLosCoeficientesDe.pdf"
