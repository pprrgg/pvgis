...
@router.post('/Res052anexoii')
def Res052anexoiiTablasConValoresDeReferenciaConsumosDe(data: dict):
    ...
    ss.nombre = "Res052anexoiiTablasConValoresDeReferenciaConsumosDe"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res052anexoiiTablasConValoresDeReferenciaConsumosDe.pdf"
