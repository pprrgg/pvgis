...
@router.post('/Res054')
def Res054AdquisiciónDeLavavajillasDeAltaEficiencia(data: dict):
    ...
    ss.nombre = "Res054AdquisiciónDeLavavajillasDeAltaEficiencia"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res054AdquisiciónDeLavavajillasDeAltaEficiencia.pdf"
