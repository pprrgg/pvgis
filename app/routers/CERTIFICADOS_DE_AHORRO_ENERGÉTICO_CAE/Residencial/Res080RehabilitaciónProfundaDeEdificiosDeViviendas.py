...
@router.post('/Res080')
def Res080RehabilitaciónProfundaDeEdificiosDeViviendas(data: dict):
    ...
    ss.nombre = "Res080RehabilitaciónProfundaDeEdificiosDeViviendas"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res080RehabilitaciónProfundaDeEdificiosDeViviendas.pdf"
