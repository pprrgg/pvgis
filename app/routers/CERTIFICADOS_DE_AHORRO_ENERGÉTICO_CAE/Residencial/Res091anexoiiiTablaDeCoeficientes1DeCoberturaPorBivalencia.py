...
@router.post('/Res091anexoiii')
def Res091anexoiiiTablaDeCoeficientes1DeCoberturaPorBivalencia(data: dict):
    ...
    ss.nombre = "Res091anexoiiiTablaDeCoeficientes1DeCoberturaPorBivalencia"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res091anexoiiiTablaDeCoeficientes1DeCoberturaPorBivalencia.pdf"
