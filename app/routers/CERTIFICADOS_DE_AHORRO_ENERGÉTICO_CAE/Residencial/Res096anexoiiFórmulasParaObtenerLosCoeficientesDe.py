...
@router.post('/Res096anexoii')
def Res096anexoiiFórmulasParaObtenerLosCoeficientesDe(data: dict):
    ...
    ss.nombre = "Res096anexoiiFórmulasParaObtenerLosCoeficientesDe"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res096anexoiiFórmulasParaObtenerLosCoeficientesDe.pdf"
