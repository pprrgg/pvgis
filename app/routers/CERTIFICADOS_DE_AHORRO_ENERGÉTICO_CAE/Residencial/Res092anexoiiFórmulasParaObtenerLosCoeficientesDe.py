...
@router.post('/Res092anexoii')
def Res092anexoiiFórmulasParaObtenerLosCoeficientesDe(data: dict):
    ...
    ss.nombre = "Res092anexoiiFórmulasParaObtenerLosCoeficientesDe"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res092anexoiiFórmulasParaObtenerLosCoeficientesDe.pdf"
