...
@router.post('/Res099anexoiii')
def Res099anexoiiiTablaDeCoeficientesDeCoberturaPorBivalencia(data: dict):
    ...
    ss.nombre = "Res099anexoiiiTablaDeCoeficientesDeCoberturaPorBivalencia"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res099anexoiiiTablaDeCoeficientesDeCoberturaPorBivalencia.pdf"
