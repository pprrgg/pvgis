...
@router.post('/Res060anexov')
def Res060anexovDocumentaciónTécnica(data: dict):
    ...
    ss.nombre = "Res060anexovDocumentaciónTécnica"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res060anexovDocumentaciónTécnica.pdf"
