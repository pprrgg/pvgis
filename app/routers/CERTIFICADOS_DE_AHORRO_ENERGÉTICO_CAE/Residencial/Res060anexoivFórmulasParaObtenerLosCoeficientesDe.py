...
@router.post('/Res060anexoiv')
def Res060anexoivFórmulasParaObtenerLosCoeficientesDe(data: dict):
    ...
    ss.nombre = "Res060anexoivFórmulasParaObtenerLosCoeficientesDe"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res060anexoivFórmulasParaObtenerLosCoeficientesDe.pdf"
