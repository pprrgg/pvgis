...
@router.post('/Res070anexoii')
def Res070anexoiiValoresDelCoeficienteGSegúnZonaClimática(data: dict):
    ...
    ss.nombre = "Res070anexoiiValoresDelCoeficienteGSegúnZonaClimática"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res070anexoiiValoresDelCoeficienteGSegúnZonaClimática.pdf"
