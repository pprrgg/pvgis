...
@router.post('/Res060anexoii')
def Res060anexoiiCasosDondeLaCalderaDeCombustiónSeMantiene(data: dict):
    ...
    ss.nombre = "Res060anexoiiCasosDondeLaCalderaDeCombustiónSeMantiene"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res060anexoiiCasosDondeLaCalderaDeCombustiónSeMantiene.pdf"
