...
@router.post('/Res021anexoii')
def Res021anexoiiValoresDelCoeficienteGSegúnZonaClimática(data: dict):
    ...
    ss.nombre = "Res021anexoiiValoresDelCoeficienteGSegúnZonaClimática"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res021anexoiiValoresDelCoeficienteGSegúnZonaClimática.pdf"
