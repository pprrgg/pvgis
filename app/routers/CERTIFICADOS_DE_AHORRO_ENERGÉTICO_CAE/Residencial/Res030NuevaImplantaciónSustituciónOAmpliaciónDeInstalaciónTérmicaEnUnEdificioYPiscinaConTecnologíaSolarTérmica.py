...
@router.post('/Res030')
def Res030NuevaImplantaciónSustituciónOAmpliaciónDeInstalaciónTérmicaEnUnEdificioYPiscinaConTecnologíaSolarTérmica(data: dict):
    ...
    ss.nombre = "Res030NuevaImplantaciónSustituciónOAmpliaciónDeInstalaciónTérmicaEnUnEdificioYPiscinaConTecnologíaSolarTérmica"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res030NuevaImplantaciónSustituciónOAmpliaciónDeInstalaciónTérmicaEnUnEdificioYPiscinaConTecnologíaSolarTérmica.pdf"
