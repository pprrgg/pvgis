...
@router.post('/Res210anexoii')
def Res210anexoiiRendimientoDeCalderaSustituida(data: dict):
    ...
    ss.nombre = "Res210anexoiiRendimientoDeCalderaSustituida"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res210anexoiiRendimientoDeCalderaSustituida.pdf"
