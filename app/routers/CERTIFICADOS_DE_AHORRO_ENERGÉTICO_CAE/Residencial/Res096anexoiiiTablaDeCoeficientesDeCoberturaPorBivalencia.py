...
@router.post('/Res096anexoiii')
def Res096anexoiiiTablaDeCoeficientesDeCoberturaPorBivalencia(data: dict):
    ...
    ss.nombre = "Res096anexoiiiTablaDeCoeficientesDeCoberturaPorBivalencia"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res096anexoiiiTablaDeCoeficientesDeCoberturaPorBivalencia.pdf"
