...
@router.post('/Res053')
def Res053AdquisiciónDeLavadorasDeAltaEficiencia(data: dict):
    ...
    ss.nombre = "Res053AdquisiciónDeLavadorasDeAltaEficiencia"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res053AdquisiciónDeLavadorasDeAltaEficiencia.pdf"
