...
@router.post('/Res230anexoii')
def Res230anexoiiFactoresParaElCálculoDelAhorroDeEnergía(data: dict):
    ...
    ss.nombre = "Res230anexoiiFactoresParaElCálculoDelAhorroDeEnergía"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res230anexoiiFactoresParaElCálculoDelAhorroDeEnergía.pdf"
