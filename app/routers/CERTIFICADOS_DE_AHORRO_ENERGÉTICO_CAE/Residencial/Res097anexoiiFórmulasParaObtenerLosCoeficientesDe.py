...
@router.post('/Res097anexoii')
def Res097anexoiiFórmulasParaObtenerLosCoeficientesDe(data: dict):
    ...
    ss.nombre = "Res097anexoiiFórmulasParaObtenerLosCoeficientesDe"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res097anexoiiFórmulasParaObtenerLosCoeficientesDe.pdf"
