...
@router.post('/Res099anexoii')
def Res099anexoiiFórmulasParaObtenerLosCoeficientesDe(data: dict):
    ...
    ss.nombre = "Res099anexoiiFórmulasParaObtenerLosCoeficientesDe"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res099anexoiiFórmulasParaObtenerLosCoeficientesDe.pdf"
