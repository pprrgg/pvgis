...
@router.post('/Res097anexoiii')
def Res097anexoiiiTablaDeCoeficientesDeCoberturaPorBivalencia(data: dict):
    ...
    ss.nombre = "Res097anexoiiiTablaDeCoeficientesDeCoberturaPorBivalencia"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res097anexoiiiTablaDeCoeficientesDeCoberturaPorBivalencia.pdf"
