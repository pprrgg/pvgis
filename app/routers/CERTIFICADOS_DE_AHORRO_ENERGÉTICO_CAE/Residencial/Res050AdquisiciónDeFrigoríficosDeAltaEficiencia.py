...
@router.post('/Res050')
def Res050AdquisiciónDeFrigoríficosDeAltaEficiencia(data: dict):
    ...
    ss.nombre = "Res050AdquisiciónDeFrigoríficosDeAltaEficiencia"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res050AdquisiciónDeFrigoríficosDeAltaEficiencia.pdf"
