...
@router.post('/Res070')
def Res070RenovaciónOSustituciónDeVentanasEnEdificiosDeViviendas(data: dict):
    ...
    ss.nombre = "Res070RenovaciónOSustituciónDeVentanasEnEdificiosDeViviendas"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res070RenovaciónOSustituciónDeVentanasEnEdificiosDeViviendas.pdf"
