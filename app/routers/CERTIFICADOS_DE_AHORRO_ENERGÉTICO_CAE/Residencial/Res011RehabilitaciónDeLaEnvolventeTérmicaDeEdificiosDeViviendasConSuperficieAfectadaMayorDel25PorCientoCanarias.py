...
@router.post('/Res011')
def Res011RehabilitaciónDeLaEnvolventeTérmicaDeEdificiosDeViviendasConSuperficieAfectadaMayorDel25PorCientoCanarias(data: dict):
    ...
    ss.nombre = "Res011RehabilitaciónDeLaEnvolventeTérmicaDeEdificiosDeViviendasConSuperficieAfectadaMayorDel25PorCientoCanarias"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res011RehabilitaciónDeLaEnvolventeTérmicaDeEdificiosDeViviendasConSuperficieAfectadaMayorDel25PorCientoCanarias.pdf"
