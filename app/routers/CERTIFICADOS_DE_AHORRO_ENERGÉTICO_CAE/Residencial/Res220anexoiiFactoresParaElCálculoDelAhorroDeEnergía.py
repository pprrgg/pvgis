...
@router.post('/Res220anexoii')
def Res220anexoiiFactoresParaElCálculoDelAhorroDeEnergía(data: dict):
    ...
    ss.nombre = "Res220anexoiiFactoresParaElCálculoDelAhorroDeEnergía"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res220anexoiiFactoresParaElCálculoDelAhorroDeEnergía.pdf"
