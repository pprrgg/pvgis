...
@router.post('/Res021')
def Res021RehabilitaciónDeLaParteOpacaDeLaEnvolventeTérmicaDeEdificiosDeViviendasConSuperficieAfectadaInferiorOIgualAl25PorCientoDeLaEnvolventeTérmicaFinalCanarias(data: dict):
    ...
    ss.nombre = "Res021RehabilitaciónDeLaParteOpacaDeLaEnvolventeTérmicaDeEdificiosDeViviendasConSuperficieAfectadaInferiorOIgualAl25PorCientoDeLaEnvolventeTérmicaFinalCanarias"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res021RehabilitaciónDeLaParteOpacaDeLaEnvolventeTérmicaDeEdificiosDeViviendasConSuperficieAfectadaInferiorOIgualAl25PorCientoDeLaEnvolventeTérmicaFinalCanarias.pdf"
