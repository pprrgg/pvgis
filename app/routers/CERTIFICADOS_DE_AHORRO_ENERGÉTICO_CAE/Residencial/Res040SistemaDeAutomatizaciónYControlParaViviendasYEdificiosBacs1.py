...
@router.post('/Res040')
def Res040SistemaDeAutomatizaciónYControlParaViviendasYEdificiosBacs1(data: dict):
    ...
    ss.nombre = "Res040SistemaDeAutomatizaciónYControlParaViviendasYEdificiosBacs1"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res040SistemaDeAutomatizaciónYControlParaViviendasYEdificiosBacs1.pdf"
