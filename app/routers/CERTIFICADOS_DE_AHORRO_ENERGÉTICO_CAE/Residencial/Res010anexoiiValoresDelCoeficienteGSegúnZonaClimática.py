...
@router.post('/Res010anexoii')
def Res010anexoiiValoresDelCoeficienteGSegúnZonaClimática(data: dict):
    ...
    ss.nombre = "Res010anexoiiValoresDelCoeficienteGSegúnZonaClimática"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res010anexoiiValoresDelCoeficienteGSegúnZonaClimática.pdf"
