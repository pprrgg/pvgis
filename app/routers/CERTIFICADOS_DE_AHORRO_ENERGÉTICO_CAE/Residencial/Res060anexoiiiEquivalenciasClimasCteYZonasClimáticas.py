...
@router.post('/Res060anexoiii')
def Res060anexoiiiEquivalenciasClimasCteYZonasClimáticas(data: dict):
    ...
    ss.nombre = "Res060anexoiiiEquivalenciasClimasCteYZonasClimáticas"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res060anexoiiiEquivalenciasClimasCteYZonasClimáticas.pdf"
