...
@router.post('/Res095')
def Res095HibridaciónEnModoAlternativoDeCalderaSDeCombustiónConBombaDeCalorDeAccionamientoEléctricoEnEdificiosResidencialesUbicadosEnLaZonaClimáticaA3OA4(data: dict):
    ...
    ss.nombre = "Res095HibridaciónEnModoAlternativoDeCalderaSDeCombustiónConBombaDeCalorDeAccionamientoEléctricoEnEdificiosResidencialesUbicadosEnLaZonaClimáticaA3OA4"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res095HibridaciónEnModoAlternativoDeCalderaSDeCombustiónConBombaDeCalorDeAccionamientoEléctricoEnEdificiosResidencialesUbicadosEnLaZonaClimáticaA3OA4.pdf"
