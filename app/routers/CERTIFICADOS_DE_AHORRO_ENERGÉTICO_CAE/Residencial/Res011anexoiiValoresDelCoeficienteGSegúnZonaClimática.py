...
@router.post('/Res011anexoii')
def Res011anexoiiValoresDelCoeficienteGSegúnZonaClimática(data: dict):
    ...
    ss.nombre = "Res011anexoiiValoresDelCoeficienteGSegúnZonaClimática"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res011anexoiiValoresDelCoeficienteGSegúnZonaClimática.pdf"
