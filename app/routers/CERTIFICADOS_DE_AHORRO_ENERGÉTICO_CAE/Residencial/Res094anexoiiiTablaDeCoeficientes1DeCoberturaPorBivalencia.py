...
@router.post('/Res094anexoiii')
def Res094anexoiiiTablaDeCoeficientes1DeCoberturaPorBivalencia(data: dict):
    ...
    ss.nombre = "Res094anexoiiiTablaDeCoeficientes1DeCoberturaPorBivalencia"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res094anexoiiiTablaDeCoeficientes1DeCoberturaPorBivalencia.pdf"
