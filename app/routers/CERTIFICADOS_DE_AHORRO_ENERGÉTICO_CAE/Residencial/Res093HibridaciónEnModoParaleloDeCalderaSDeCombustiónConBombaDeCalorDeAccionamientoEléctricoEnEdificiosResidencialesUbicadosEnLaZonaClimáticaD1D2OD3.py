...
@router.post('/Res093')
def Res093HibridaciónEnModoParaleloDeCalderaSDeCombustiónConBombaDeCalorDeAccionamientoEléctricoEnEdificiosResidencialesUbicadosEnLaZonaClimáticaD1D2OD3(data: dict):
    ...
    ss.nombre = "Res093HibridaciónEnModoParaleloDeCalderaSDeCombustiónConBombaDeCalorDeAccionamientoEléctricoEnEdificiosResidencialesUbicadosEnLaZonaClimáticaD1D2OD3"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res093HibridaciónEnModoParaleloDeCalderaSDeCombustiónConBombaDeCalorDeAccionamientoEléctricoEnEdificiosResidencialesUbicadosEnLaZonaClimáticaD1D2OD3.pdf"
