...
@router.post('/Res071anexoii')
def Res071anexoiiValoresDeCoeficienteGSegúnZonaClimática(data: dict):
    ...
    ss.nombre = "Res071anexoiiValoresDeCoeficienteGSegúnZonaClimática"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res071anexoiiValoresDeCoeficienteGSegúnZonaClimática.pdf"
