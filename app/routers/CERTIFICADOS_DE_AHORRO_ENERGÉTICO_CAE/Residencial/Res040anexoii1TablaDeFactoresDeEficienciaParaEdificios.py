...
@router.post('/Res040anexoii1')
def Res040anexoii1TablaDeFactoresDeEficienciaParaEdificios(data: dict):
    ...
    ss.nombre = "Res040anexoii1TablaDeFactoresDeEficienciaParaEdificios"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res040anexoii1TablaDeFactoresDeEficienciaParaEdificios.pdf"
