...
@router.post('/Res050anexoii')
def Res050anexoiiTablasConValoresDeReferenciaConsumosDe(data: dict):
    ...
    ss.nombre = "Res050anexoiiTablasConValoresDeReferenciaConsumosDe"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res050anexoiiTablasConValoresDeReferenciaConsumosDe.pdf"
