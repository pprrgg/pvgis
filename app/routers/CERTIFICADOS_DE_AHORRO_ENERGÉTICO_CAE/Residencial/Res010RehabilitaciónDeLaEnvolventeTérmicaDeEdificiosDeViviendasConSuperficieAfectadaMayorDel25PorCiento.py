...
@router.post('/Res010')
def Res010RehabilitaciónDeLaEnvolventeTérmicaDeEdificiosDeViviendasConSuperficieAfectadaMayorDel25PorCiento(data: dict):
    ...
    ss.nombre = "Res010RehabilitaciónDeLaEnvolventeTérmicaDeEdificiosDeViviendasConSuperficieAfectadaMayorDel25PorCiento"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res010RehabilitaciónDeLaEnvolventeTérmicaDeEdificiosDeViviendasConSuperficieAfectadaMayorDel25PorCiento.pdf"
