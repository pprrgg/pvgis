...
@router.post('/Res052')
def Res052AdquisiciónDeCongeladorDeAltaEficiencia(data: dict):
    ...
    ss.nombre = "Res052AdquisiciónDeCongeladorDeAltaEficiencia"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res052AdquisiciónDeCongeladorDeAltaEficiencia.pdf"
