...
@router.post('/Res051')
def Res051AdquisiciónDeFrigoríficocongeladorDeAltaEficiencia(data: dict):
    ...
    ss.nombre = "Res051AdquisiciónDeFrigoríficocongeladorDeAltaEficiencia"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res051AdquisiciónDeFrigoríficocongeladorDeAltaEficiencia.pdf"
