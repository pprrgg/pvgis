...
@router.post('/Res092anexoiii')
def Res092anexoiiiTablaDeCoeficientes1DeCoberturaPorBivalencia(data: dict):
    ...
    ss.nombre = "Res092anexoiiiTablaDeCoeficientes1DeCoberturaPorBivalencia"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res092anexoiiiTablaDeCoeficientes1DeCoberturaPorBivalencia.pdf"
