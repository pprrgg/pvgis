...
@router.post('/Res098anexoiii')
def Res098anexoiiiTablaDeCoeficientesDeCoberturaPorBivalencia(data: dict):
    ...
    ss.nombre = "Res098anexoiiiTablaDeCoeficientesDeCoberturaPorBivalencia"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res098anexoiiiTablaDeCoeficientesDeCoberturaPorBivalencia.pdf"
