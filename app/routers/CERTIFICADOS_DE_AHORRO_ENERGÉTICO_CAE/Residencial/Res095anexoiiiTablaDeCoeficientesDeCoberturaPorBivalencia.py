...
@router.post('/Res095anexoiii')
def Res095anexoiiiTablaDeCoeficientesDeCoberturaPorBivalencia(data: dict):
    ...
    ss.nombre = "Res095anexoiiiTablaDeCoeficientesDeCoberturaPorBivalencia"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res095anexoiiiTablaDeCoeficientesDeCoberturaPorBivalencia.pdf"
