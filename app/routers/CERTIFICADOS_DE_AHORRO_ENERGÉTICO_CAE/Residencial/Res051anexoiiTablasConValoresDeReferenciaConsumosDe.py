...
@router.post('/Res051anexoii')
def Res051anexoiiTablasConValoresDeReferenciaConsumosDe(data: dict):
    ...
    ss.nombre = "Res051anexoiiTablasConValoresDeReferenciaConsumosDe"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res051anexoiiTablasConValoresDeReferenciaConsumosDe.pdf"
