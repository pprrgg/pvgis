...
@router.post('/Res040anexoiii')
def Res040anexoiiiDeclaraciónResponsableDeLaEvaluaciónDeLa(data: dict):
    ...
    ss.nombre = "Res040anexoiiiDeclaraciónResponsableDeLaEvaluaciónDeLa"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res040anexoiiiDeclaraciónResponsableDeLaEvaluaciónDeLa.pdf"
