...
@router.post('/Res098anexoii')
def Res098anexoiiFórmulasParaObtenerLosCoeficientesDe(data: dict):
    ...
    ss.nombre = "Res098anexoiiFórmulasParaObtenerLosCoeficientesDe"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res098anexoiiFórmulasParaObtenerLosCoeficientesDe.pdf"
