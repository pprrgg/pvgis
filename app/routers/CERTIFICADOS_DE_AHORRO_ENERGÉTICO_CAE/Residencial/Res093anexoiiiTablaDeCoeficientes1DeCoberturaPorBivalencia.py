...
@router.post('/Res093anexoiii')
def Res093anexoiiiTablaDeCoeficientes1DeCoberturaPorBivalencia(data: dict):
    ...
    ss.nombre = "Res093anexoiiiTablaDeCoeficientes1DeCoberturaPorBivalencia"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res093anexoiiiTablaDeCoeficientes1DeCoberturaPorBivalencia.pdf"
