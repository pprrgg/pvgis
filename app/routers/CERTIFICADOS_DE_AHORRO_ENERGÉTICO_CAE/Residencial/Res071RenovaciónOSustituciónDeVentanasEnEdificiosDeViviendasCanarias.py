...
@router.post('/Res071')
def Res071RenovaciónOSustituciónDeVentanasEnEdificiosDeViviendasCanarias(data: dict):
    ...
    ss.nombre = "Res071RenovaciónOSustituciónDeVentanasEnEdificiosDeViviendasCanarias"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res071RenovaciónOSustituciónDeVentanasEnEdificiosDeViviendasCanarias.pdf"
