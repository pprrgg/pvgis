...
@router.post('/Res053anexoii')
def Res053anexoiiTablasConValoresDeReferenciaConsumosDe(data: dict):
    ...
    ss.nombre = "Res053anexoiiTablasConValoresDeReferenciaConsumosDe"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res053anexoiiTablasConValoresDeReferenciaConsumosDe.pdf"
