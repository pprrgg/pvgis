...
@router.post('/Res091anexoii')
def Res091anexoiiFórmulasParaObtenerLosCoeficientesDe(data: dict):
    ...
    ss.nombre = "Res091anexoiiFórmulasParaObtenerLosCoeficientesDe"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res091anexoiiFórmulasParaObtenerLosCoeficientesDe.pdf"
