...
@router.post('/Agr010')
def Agr010PantallasTérmicasEnInvernaderos(data: dict):
    ...
    ss.nombre = "Agr010PantallasTérmicasEnInvernaderos"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Agrario/Agr010PantallasTérmicasEnInvernaderos.pdf"
