...
def Agr010anexoiiiDeclaraciónResponsableDelValorDel(data: dict):
    ...
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Agrario/Agr010anexoiiiDeclaraciónResponsableDelValorDel.pdf"
