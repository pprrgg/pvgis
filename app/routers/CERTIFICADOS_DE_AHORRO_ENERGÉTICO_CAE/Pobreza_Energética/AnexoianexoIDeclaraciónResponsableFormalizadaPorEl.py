...
@router.post('/Anexoianexo')
def AnexoianexoIDeclaraciónResponsableFormalizadaPorEl(data: dict):
    ...
    ss.nombre = "AnexoianexoIDeclaraciónResponsableFormalizadaPorEl"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Pobreza_Energética/AnexoianexoIDeclaraciónResponsableFormalizadaPorEl.pdf"
