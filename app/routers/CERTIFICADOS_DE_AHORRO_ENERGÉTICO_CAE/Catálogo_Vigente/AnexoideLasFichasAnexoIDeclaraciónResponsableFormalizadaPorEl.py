...
@router.post('/Anexoide')
def AnexoideLasFichasAnexoIDeclaraciónResponsableFormalizadaPorEl(data: dict):
    ...
    ss.nombre = "AnexoideLasFichasAnexoIDeclaraciónResponsableFormalizadaPorEl"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Catálogo_Vigente/AnexoideLasFichasAnexoIDeclaraciónResponsableFormalizadaPorEl.pdf"
