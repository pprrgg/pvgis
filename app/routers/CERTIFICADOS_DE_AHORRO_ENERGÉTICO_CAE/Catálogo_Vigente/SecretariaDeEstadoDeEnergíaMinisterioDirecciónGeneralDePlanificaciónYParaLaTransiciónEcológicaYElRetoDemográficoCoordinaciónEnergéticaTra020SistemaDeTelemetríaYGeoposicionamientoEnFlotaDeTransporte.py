...
def SecretariaDeEstadoDeEnergíaMinisterioDirecciónGeneralDePlanificaciónYParaLaTransiciónEcológicaYElRetoDemográficoCoordinaciónEnergéticaTra020SistemaDeTelemetríaYGeoposicionamientoEnFlotaDeTransporte(data: dict):
    ...
    ss.nombre = "SecretariaDeEstadoDeEnergíaMinisterioDirecciónGeneralDePlanificaciónYParaLaTransiciónEcológicaYElRetoDemográficoCoordinaciónEnergéticaTra020SistemaDeTelemetríaYGeoposicionamientoEnFlotaDeTransporte"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Catálogo_Vigente/SecretariaDeEstadoDeEnergíaMinisterioDirecciónGeneralDePlanificaciónYParaLaTransiciónEcológicaYElRetoDemográficoCoordinaciónEnergéticaTra020SistemaDeTelemetríaYGeoposicionamientoEnFlotaDeTransporte.pdf"
