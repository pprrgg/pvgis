...
@router.post('/Ter120')
def Ter120SustituciónDeQuemadorModulanteDeCalderaDeCombustiónDeGas(data: dict):
    ...
    ss.nombre = "Ter120SustituciónDeQuemadorModulanteDeCalderaDeCombustiónDeGas"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter120SustituciónDeQuemadorModulanteDeCalderaDeCombustiónDeGas.pdf"
