...
@router.post('/Ter160')
def Ter160SustituciónReformaONuevaInstalaciónDeUnaUnidadCondensadoraDeAltaEficiencia(data: dict):
    ...
    ss.nombre = "Ter160SustituciónReformaONuevaInstalaciónDeUnaUnidadCondensadoraDeAltaEficiencia"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter160SustituciónReformaONuevaInstalaciónDeUnaUnidadCondensadoraDeAltaEficiencia.pdf"
