...
@router.post('/Ter170anexoii')
def Ter170anexoiiFórmulasParaObtenerLosCoeficientesDe(data: dict):
    ...
    ss.nombre = "Ter170anexoiiFórmulasParaObtenerLosCoeficientesDe"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter170anexoiiFórmulasParaObtenerLosCoeficientesDe.pdf"
