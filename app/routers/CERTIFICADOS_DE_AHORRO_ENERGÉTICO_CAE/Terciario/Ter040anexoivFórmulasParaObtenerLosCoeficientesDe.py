...
@router.post('/Ter040anexoiv')
def Ter040anexoivFórmulasParaObtenerLosCoeficientesDe(data: dict):
    ...
    ss.nombre = "Ter040anexoivFórmulasParaObtenerLosCoeficientesDe"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter040anexoivFórmulasParaObtenerLosCoeficientesDe.pdf"
