...
@router.post('/Ter178anexoii')
def Ter178anexoiiFórmulasParaObtenerLosCoeficientesDe(data: dict):
    ...
    ss.nombre = "Ter178anexoiiFórmulasParaObtenerLosCoeficientesDe"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter178anexoiiFórmulasParaObtenerLosCoeficientesDe.pdf"
