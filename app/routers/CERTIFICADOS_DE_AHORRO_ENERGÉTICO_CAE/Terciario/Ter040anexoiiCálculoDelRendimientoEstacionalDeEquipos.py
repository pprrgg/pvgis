...
@router.post('/Ter040anexoii')
def Ter040anexoiiCálculoDelRendimientoEstacionalDeEquipos(data: dict):
    ...
    ss.nombre = "Ter040anexoiiCálculoDelRendimientoEstacionalDeEquipos"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter040anexoiiCálculoDelRendimientoEstacionalDeEquipos.pdf"
