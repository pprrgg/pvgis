...
@router.post('/Ter174anexoii')
def Ter174anexoiiFórmulasParaObtenerLosCoeficientesDe(data: dict):
    ...
    ss.nombre = "Ter174anexoiiFórmulasParaObtenerLosCoeficientesDe"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter174anexoiiFórmulasParaObtenerLosCoeficientesDe.pdf"
