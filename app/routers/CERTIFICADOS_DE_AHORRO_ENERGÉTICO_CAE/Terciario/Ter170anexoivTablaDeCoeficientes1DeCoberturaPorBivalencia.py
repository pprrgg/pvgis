...
@router.post('/Ter170anexoiv')
def Ter170anexoivTablaDeCoeficientes1DeCoberturaPorBivalencia(data: dict):
    ...
    ss.nombre = "Ter170anexoivTablaDeCoeficientes1DeCoberturaPorBivalencia"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter170anexoivTablaDeCoeficientes1DeCoberturaPorBivalencia.pdf"
