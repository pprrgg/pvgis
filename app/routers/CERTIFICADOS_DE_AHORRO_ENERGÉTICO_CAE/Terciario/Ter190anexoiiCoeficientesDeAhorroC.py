...
@router.post('/Ter190anexoii')
def Ter190anexoiiCoeficientesDeAhorroC(data: dict):
    ...
    ss.nombre = "Ter190anexoiiCoeficientesDeAhorroC"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter190anexoiiCoeficientesDeAhorroC.pdf"
