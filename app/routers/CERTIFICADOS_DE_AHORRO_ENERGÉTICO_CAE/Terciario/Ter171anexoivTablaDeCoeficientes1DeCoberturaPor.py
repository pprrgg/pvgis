...
@router.post('/Ter171anexoiv')
def Ter171anexoivTablaDeCoeficientes1DeCoberturaPor(data: dict):
    ...
    ss.nombre = "Ter171anexoivTablaDeCoeficientes1DeCoberturaPor"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter171anexoivTablaDeCoeficientes1DeCoberturaPor.pdf"
