...
@router.post('/Ter175anexoiv')
def Ter175anexoivTablaDeCoeficientesDeCoberturaPorBivalencia(data: dict):
    ...
    ss.nombre = "Ter175anexoivTablaDeCoeficientesDeCoberturaPorBivalencia"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter175anexoivTablaDeCoeficientesDeCoberturaPorBivalencia.pdf"
