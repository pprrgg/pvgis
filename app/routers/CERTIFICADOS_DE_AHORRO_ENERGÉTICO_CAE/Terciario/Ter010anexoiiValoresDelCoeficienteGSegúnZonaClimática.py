...
@router.post('/Ter010anexoii')
def Ter010anexoiiValoresDelCoeficienteGSegúnZonaClimática(data: dict):
    ...
    ss.nombre = "Ter010anexoiiValoresDelCoeficienteGSegúnZonaClimática"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter010anexoiiValoresDelCoeficienteGSegúnZonaClimática.pdf"
