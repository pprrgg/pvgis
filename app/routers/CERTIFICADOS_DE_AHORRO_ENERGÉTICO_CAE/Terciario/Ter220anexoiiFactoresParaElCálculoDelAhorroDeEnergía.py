...
@router.post('/Ter220anexoii')
def Ter220anexoiiFactoresParaElCálculoDelAhorroDeEnergía(data: dict):
    ...
    ss.nombre = "Ter220anexoiiFactoresParaElCálculoDelAhorroDeEnergía"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter220anexoiiFactoresParaElCálculoDelAhorroDeEnergía.pdf"
