...
@router.post('/Ter260anexoii')
def Ter260anexoiiDeclaraciónResponsablePorLaEmpresa(data: dict):
    ...
    ss.nombre = "Ter260anexoiiDeclaraciónResponsablePorLaEmpresa"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter260anexoiiDeclaraciónResponsablePorLaEmpresa.pdf"
