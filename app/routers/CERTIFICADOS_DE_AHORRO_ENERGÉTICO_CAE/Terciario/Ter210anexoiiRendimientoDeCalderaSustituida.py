...
@router.post('/Ter210anexoii')
def Ter210anexoiiRendimientoDeCalderaSustituida(data: dict):
    ...
    ss.nombre = "Ter210anexoiiRendimientoDeCalderaSustituida"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter210anexoiiRendimientoDeCalderaSustituida.pdf"
