...
@router.post('/Ter100anexoviii')
def Ter100anexoviiiRendimientoDeCalderaSustituida(data: dict):
    ...
    ss.nombre = "Ter100anexoviiiRendimientoDeCalderaSustituida"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter100anexoviiiRendimientoDeCalderaSustituida.pdf"
