...
@router.post('/Ter280anexoii')
def Ter280anexoiiCálculoDelRendimientoTotalDeLaBomba(data: dict):
    ...
    ss.nombre = "Ter280anexoiiCálculoDelRendimientoTotalDeLaBomba"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter280anexoiiCálculoDelRendimientoTotalDeLaBomba.pdf"
