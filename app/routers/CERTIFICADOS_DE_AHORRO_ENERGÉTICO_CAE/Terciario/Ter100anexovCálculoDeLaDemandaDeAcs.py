...
@router.post('/Ter100anexov')
def Ter100anexovCálculoDeLaDemandaDeAcs(data: dict):
    ...
    ss.nombre = "Ter100anexovCálculoDeLaDemandaDeAcs"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter100anexovCálculoDeLaDemandaDeAcs.pdf"
