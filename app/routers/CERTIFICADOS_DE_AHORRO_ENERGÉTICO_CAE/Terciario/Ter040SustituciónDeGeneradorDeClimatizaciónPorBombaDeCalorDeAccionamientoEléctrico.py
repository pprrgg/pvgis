...
@router.post('/Ter040')
def Ter040SustituciónDeGeneradorDeClimatizaciónPorBombaDeCalorDeAccionamientoEléctrico(data: dict):
    ...
    ss.nombre = "Ter040SustituciónDeGeneradorDeClimatizaciónPorBombaDeCalorDeAccionamientoEléctrico"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter040SustituciónDeGeneradorDeClimatizaciónPorBombaDeCalorDeAccionamientoEléctrico.pdf"
