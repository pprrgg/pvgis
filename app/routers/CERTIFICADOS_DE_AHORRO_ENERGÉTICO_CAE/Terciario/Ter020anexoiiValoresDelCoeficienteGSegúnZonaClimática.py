...
@router.post('/Ter020anexoii')
def Ter020anexoiiValoresDelCoeficienteGSegúnZonaClimática(data: dict):
    ...
    ss.nombre = "Ter020anexoiiValoresDelCoeficienteGSegúnZonaClimática"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter020anexoiiValoresDelCoeficienteGSegúnZonaClimática.pdf"
