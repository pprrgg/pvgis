...
@router.post('/Ter176anexoiv')
def Ter176anexoivTablaDeCoeficientesDeCoberturaPorBivalencia(data: dict):
    ...
    ss.nombre = "Ter176anexoivTablaDeCoeficientesDeCoberturaPorBivalencia"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter176anexoivTablaDeCoeficientesDeCoberturaPorBivalencia.pdf"
