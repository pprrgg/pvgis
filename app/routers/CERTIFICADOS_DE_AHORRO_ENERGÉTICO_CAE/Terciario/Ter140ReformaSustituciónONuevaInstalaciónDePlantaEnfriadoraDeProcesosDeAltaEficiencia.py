...
@router.post('/Ter140')
def Ter140ReformaSustituciónONuevaInstalaciónDePlantaEnfriadoraDeProcesosDeAltaEficiencia(data: dict):
    ...
    ss.nombre = "Ter140ReformaSustituciónONuevaInstalaciónDePlantaEnfriadoraDeProcesosDeAltaEficiencia"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter140ReformaSustituciónONuevaInstalaciónDePlantaEnfriadoraDeProcesosDeAltaEficiencia.pdf"
