...
@router.post('/Ter220')
def Ter220SustituciónDeUnSistemaDeVentilaciónExistenteNaturalOMecánicaPorUnSistemaDeVentilaciónMecánicaConRecuperaciónDeCalorDeAltaEficienciaEnEdificiosNoResidenciales(data: dict):
    ...
    ss.nombre = "Ter220SustituciónDeUnSistemaDeVentilaciónExistenteNaturalOMecánicaPorUnSistemaDeVentilaciónMecánicaConRecuperaciónDeCalorDeAltaEficienciaEnEdificiosNoResidenciales"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter220SustituciónDeUnSistemaDeVentilaciónExistenteNaturalOMecánicaPorUnSistemaDeVentilaciónMecánicaConRecuperaciónDeCalorDeAltaEficienciaEnEdificiosNoResidenciales.pdf"
