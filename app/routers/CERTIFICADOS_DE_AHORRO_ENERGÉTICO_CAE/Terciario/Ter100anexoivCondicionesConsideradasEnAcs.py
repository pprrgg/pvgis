...
@router.post('/Ter100anexoiv')
def Ter100anexoivCondicionesConsideradasEnAcs(data: dict):
    ...
    ss.nombre = "Ter100anexoivCondicionesConsideradasEnAcs"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter100anexoivCondicionesConsideradasEnAcs.pdf"
