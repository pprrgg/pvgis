...
@router.post('/Ter050anexoiii')
def Ter050anexoiiiDeclaraciónResponsableDeLaEvaluaciónDeLa(data: dict):
    ...
    ss.nombre = "Ter050anexoiiiDeclaraciónResponsableDeLaEvaluaciónDeLa"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter050anexoiiiDeclaraciónResponsableDeLaEvaluaciónDeLa.pdf"
