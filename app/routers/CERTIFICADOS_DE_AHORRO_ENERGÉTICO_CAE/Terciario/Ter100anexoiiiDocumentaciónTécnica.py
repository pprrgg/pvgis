...
@router.post('/Ter100anexoiii')
def Ter100anexoiiiDocumentaciónTécnica(data: dict):
    ...
    ss.nombre = "Ter100anexoiiiDocumentaciónTécnica"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter100anexoiiiDocumentaciónTécnica.pdf"
