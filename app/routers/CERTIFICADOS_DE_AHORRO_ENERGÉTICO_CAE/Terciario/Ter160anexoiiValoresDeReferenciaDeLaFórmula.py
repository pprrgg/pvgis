...
@router.post('/Ter160anexoii')
def Ter160anexoiiValoresDeReferenciaDeLaFórmula(data: dict):
    ...
    ss.nombre = "Ter160anexoiiValoresDeReferenciaDeLaFórmula"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter160anexoiiValoresDeReferenciaDeLaFórmula.pdf"
