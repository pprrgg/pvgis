...
@router.post('/Ter176anexoii')
def Ter176anexoiiFórmulasParaObtenerLosCoeficientesDe(data: dict):
    ...
    ss.nombre = "Ter176anexoiiFórmulasParaObtenerLosCoeficientesDe"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter176anexoiiFórmulasParaObtenerLosCoeficientesDe.pdf"
