...
@router.post('/Ter040anexoix')
def Ter040anexoixCondicionesDeTemperaturaExteriorMedia(data: dict):
    ...
    ss.nombre = "Ter040anexoixCondicionesDeTemperaturaExteriorMedia"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter040anexoixCondicionesDeTemperaturaExteriorMedia.pdf"
