...
@router.post('/Ter260')
def Ter260SustituciónDeUnSistemaDeAlimentaciónIninterrumpidaSai(data: dict):
    ...
    ss.nombre = "Ter260SustituciónDeUnSistemaDeAlimentaciónIninterrumpidaSai"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter260SustituciónDeUnSistemaDeAlimentaciónIninterrumpidaSai.pdf"
