...
@router.post('/Ter280')
def Ter280SustituciónDeBombaPorOtraMásEficiente(data: dict):
    ...
    ss.nombre = "Ter280SustituciónDeBombaPorOtraMásEficiente"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter280SustituciónDeBombaPorOtraMásEficiente.pdf"
