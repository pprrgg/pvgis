...
@router.post('/Ter140anexoiii')
def Ter140anexoiiiInformeJustificativoDeLaCentralFrigorífica(data: dict):
    ...
    ss.nombre = "Ter140anexoiiiInformeJustificativoDeLaCentralFrigorífica"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter140anexoiiiInformeJustificativoDeLaCentralFrigorífica.pdf"
