...
@router.post('/Ter172anexoiii')
def Ter172anexoiiiCondicionesGeneralesParaCálculoDeLa(data: dict):
    ...
    ss.nombre = "Ter172anexoiiiCondicionesGeneralesParaCálculoDeLa"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter172anexoiiiCondicionesGeneralesParaCálculoDeLa.pdf"
