...
@router.post('/Ter040anexoiii')
def Ter040anexoiiiEquivalenciasClimasCteYZonasClimáticas(data: dict):
    ...
    ss.nombre = "Ter040anexoiiiEquivalenciasClimasCteYZonasClimáticas"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter040anexoiiiEquivalenciasClimasCteYZonasClimáticas.pdf"
