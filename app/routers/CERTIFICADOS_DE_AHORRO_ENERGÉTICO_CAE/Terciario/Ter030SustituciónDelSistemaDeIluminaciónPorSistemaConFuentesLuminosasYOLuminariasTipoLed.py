...
@router.post('/Ter030')
def Ter030SustituciónDelSistemaDeIluminaciónPorSistemaConFuentesLuminosasYOLuminariasTipoLed(data: dict):
    ...
    ss.nombre = "Ter030SustituciónDelSistemaDeIluminaciónPorSistemaConFuentesLuminosasYOLuminariasTipoLed"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter030SustituciónDelSistemaDeIluminaciónPorSistemaConFuentesLuminosasYOLuminariasTipoLed.pdf"
