...
@router.post('/Ter210')
def Ter210SustituciónDeCalderasIndividualesColectivaEnEdificioTerciarioPorConexiónAUnaRedDeCalor(data: dict):
    ...
    ss.nombre = "Ter210SustituciónDeCalderasIndividualesColectivaEnEdificioTerciarioPorConexiónAUnaRedDeCalor"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter210SustituciónDeCalderasIndividualesColectivaEnEdificioTerciarioPorConexiónAUnaRedDeCalor.pdf"
