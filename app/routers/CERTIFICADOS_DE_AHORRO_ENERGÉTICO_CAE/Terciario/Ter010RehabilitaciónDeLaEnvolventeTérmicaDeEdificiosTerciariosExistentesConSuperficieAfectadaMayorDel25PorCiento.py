...
@router.post('/Ter010')
def Ter010RehabilitaciónDeLaEnvolventeTérmicaDeEdificiosTerciariosExistentesConSuperficieAfectadaMayorDel25PorCiento(data: dict):
    ...
    ss.nombre = "Ter010RehabilitaciónDeLaEnvolventeTérmicaDeEdificiosTerciariosExistentesConSuperficieAfectadaMayorDel25PorCiento"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter010RehabilitaciónDeLaEnvolventeTérmicaDeEdificiosTerciariosExistentesConSuperficieAfectadaMayorDel25PorCiento.pdf"
