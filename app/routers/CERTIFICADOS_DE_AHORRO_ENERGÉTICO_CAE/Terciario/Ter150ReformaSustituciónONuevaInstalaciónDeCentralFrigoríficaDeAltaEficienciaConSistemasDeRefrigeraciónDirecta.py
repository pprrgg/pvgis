...
@router.post('/Ter150')
def Ter150ReformaSustituciónONuevaInstalaciónDeCentralFrigoríficaDeAltaEficienciaConSistemasDeRefrigeraciónDirecta(data: dict):
    ...
    ss.nombre = "Ter150ReformaSustituciónONuevaInstalaciónDeCentralFrigoríficaDeAltaEficienciaConSistemasDeRefrigeraciónDirecta"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter150ReformaSustituciónONuevaInstalaciónDeCentralFrigoríficaDeAltaEficienciaConSistemasDeRefrigeraciónDirecta.pdf"
