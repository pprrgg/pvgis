...
@router.post('/Ter179anexoiv')
def Ter179anexoivTablaDeCoeficientesDeCoberturaPorBivalencia(data: dict):
    ...
    ss.nombre = "Ter179anexoivTablaDeCoeficientesDeCoberturaPorBivalencia"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter179anexoivTablaDeCoeficientesDeCoberturaPorBivalencia.pdf"
