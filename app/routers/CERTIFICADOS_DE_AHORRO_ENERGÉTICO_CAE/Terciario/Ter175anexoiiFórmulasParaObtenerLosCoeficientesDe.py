...
@router.post('/Ter175anexoii')
def Ter175anexoiiFórmulasParaObtenerLosCoeficientesDe(data: dict):
    ...
    ss.nombre = "Ter175anexoiiFórmulasParaObtenerLosCoeficientesDe"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter175anexoiiFórmulasParaObtenerLosCoeficientesDe.pdf"
