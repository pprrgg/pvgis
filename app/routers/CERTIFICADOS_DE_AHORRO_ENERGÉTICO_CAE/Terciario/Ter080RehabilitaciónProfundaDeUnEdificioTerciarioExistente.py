...
@router.post('/Ter080')
def Ter080RehabilitaciónProfundaDeUnEdificioTerciarioExistente(data: dict):
    ...
    ss.nombre = "Ter080RehabilitaciónProfundaDeUnEdificioTerciarioExistente"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter080RehabilitaciónProfundaDeUnEdificioTerciarioExistente.pdf"
