...
@router.post('/Ter050anexoii1')
def Ter050anexoii1TablaDeFactoresDeEficienciaParaEdificiosNo(data: dict):
    ...
    ss.nombre = "Ter050anexoii1TablaDeFactoresDeEficienciaParaEdificiosNo"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter050anexoii1TablaDeFactoresDeEficienciaParaEdificiosNo.pdf"
