...
@router.post('/Ter150anexoiii')
def Ter150anexoiiiInformeJustificativoDeLaCentralFrigorífica(data: dict):
    ...
    ss.nombre = "Ter150anexoiiiInformeJustificativoDeLaCentralFrigorífica"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter150anexoiiiInformeJustificativoDeLaCentralFrigorífica.pdf"
