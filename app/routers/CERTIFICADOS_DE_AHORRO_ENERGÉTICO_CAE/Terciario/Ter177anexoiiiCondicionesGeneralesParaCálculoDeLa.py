...
@router.post('/Ter177anexoiii')
def Ter177anexoiiiCondicionesGeneralesParaCálculoDeLa(data: dict):
    ...
    ss.nombre = "Ter177anexoiiiCondicionesGeneralesParaCálculoDeLa"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter177anexoiiiCondicionesGeneralesParaCálculoDeLa.pdf"
