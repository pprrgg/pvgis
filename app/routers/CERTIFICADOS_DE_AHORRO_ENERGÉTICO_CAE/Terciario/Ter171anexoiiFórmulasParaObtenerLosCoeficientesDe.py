...
@router.post('/Ter171anexoii')
def Ter171anexoiiFórmulasParaObtenerLosCoeficientesDe(data: dict):
    ...
    ss.nombre = "Ter171anexoiiFórmulasParaObtenerLosCoeficientesDe"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter171anexoiiFórmulasParaObtenerLosCoeficientesDe.pdf"
