...
@router.post('/Ter177anexoii')
def Ter177anexoiiFórmulasParaObtenerLosCoeficientesDe(data: dict):
    ...
    ss.nombre = "Ter177anexoiiFórmulasParaObtenerLosCoeficientesDe"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter177anexoiiFórmulasParaObtenerLosCoeficientesDe.pdf"
