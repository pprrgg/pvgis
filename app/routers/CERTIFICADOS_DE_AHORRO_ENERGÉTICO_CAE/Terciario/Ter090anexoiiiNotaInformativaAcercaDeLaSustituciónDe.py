...
@router.post('/Ter090anexoiii')
def Ter090anexoiiiNotaInformativaAcercaDeLaSustituciónDe(data: dict):
    ...
    ss.nombre = "Ter090anexoiiiNotaInformativaAcercaDeLaSustituciónDe"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter090anexoiiiNotaInformativaAcercaDeLaSustituciónDe.pdf"
