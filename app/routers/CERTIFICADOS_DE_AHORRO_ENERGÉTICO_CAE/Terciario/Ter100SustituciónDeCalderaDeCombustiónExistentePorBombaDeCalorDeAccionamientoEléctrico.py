...
@router.post('/Ter100')
def Ter100SustituciónDeCalderaDeCombustiónExistentePorBombaDeCalorDeAccionamientoEléctrico(data: dict):
    ...
    ss.nombre = "Ter100SustituciónDeCalderaDeCombustiónExistentePorBombaDeCalorDeAccionamientoEléctrico"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter100SustituciónDeCalderaDeCombustiónExistentePorBombaDeCalorDeAccionamientoEléctrico.pdf"
