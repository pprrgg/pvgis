...
@router.post('/Ter040anexov')
def Ter040anexovDocumentaciónTécnica(data: dict):
    ...
    ss.nombre = "Ter040anexovDocumentaciónTécnica"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter040anexovDocumentaciónTécnica.pdf"
