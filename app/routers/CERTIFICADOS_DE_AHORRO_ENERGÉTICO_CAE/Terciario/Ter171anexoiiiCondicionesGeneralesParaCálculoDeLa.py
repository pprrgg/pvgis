...
@router.post('/Ter171anexoiii')
def Ter171anexoiiiCondicionesGeneralesParaCálculoDeLa(data: dict):
    ...
    ss.nombre = "Ter171anexoiiiCondicionesGeneralesParaCálculoDeLa"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter171anexoiiiCondicionesGeneralesParaCálculoDeLa.pdf"
