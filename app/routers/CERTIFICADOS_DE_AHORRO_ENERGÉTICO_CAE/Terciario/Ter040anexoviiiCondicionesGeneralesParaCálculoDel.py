...
@router.post('/Ter040anexoviii')
def Ter040anexoviiiCondicionesGeneralesParaCálculoDel(data: dict):
    ...
    ss.nombre = "Ter040anexoviiiCondicionesGeneralesParaCálculoDel"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter040anexoviiiCondicionesGeneralesParaCálculoDel.pdf"
