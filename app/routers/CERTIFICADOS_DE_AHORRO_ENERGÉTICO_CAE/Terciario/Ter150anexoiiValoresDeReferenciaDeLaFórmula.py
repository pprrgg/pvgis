...
@router.post('/Ter150anexoii')
def Ter150anexoiiValoresDeReferenciaDeLaFórmula(data: dict):
    ...
    ss.nombre = "Ter150anexoiiValoresDeReferenciaDeLaFórmula"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter150anexoiiValoresDeReferenciaDeLaFórmula.pdf"
