...
@router.post('/Ter021anexoii')
def Ter021anexoiiValoresDelCoeficienteGSegúnZonaClimática(data: dict):
    ...
    ss.nombre = "Ter021anexoiiValoresDelCoeficienteGSegúnZonaClimática"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter021anexoiiValoresDelCoeficienteGSegúnZonaClimática.pdf"
