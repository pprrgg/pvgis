...
@router.post('/Ter090anexoii')
def Ter090anexoiiTablas(data: dict):
    ...
    ss.nombre = "Ter090anexoiiTablas"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter090anexoiiTablas.pdf"
