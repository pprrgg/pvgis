...
@router.post('/Ter178anexoiv')
def Ter178anexoivTablaDeCoeficientesDeCoberturaPorBivalencia(data: dict):
    ...
    ss.nombre = "Ter178anexoivTablaDeCoeficientesDeCoberturaPorBivalencia"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter178anexoivTablaDeCoeficientesDeCoberturaPorBivalencia.pdf"
