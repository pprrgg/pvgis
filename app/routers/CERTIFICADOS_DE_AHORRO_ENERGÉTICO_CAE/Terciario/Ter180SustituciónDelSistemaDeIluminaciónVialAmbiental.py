...
@router.post('/Ter180')
def Ter180SustituciónDelSistemaDeIluminaciónVialAmbiental(data: dict):
    ...
    ss.nombre = "Ter180SustituciónDelSistemaDeIluminaciónVialAmbiental"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter180SustituciónDelSistemaDeIluminaciónVialAmbiental.pdf"
