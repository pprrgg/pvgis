...
@router.post('/Ter160anexoiii')
def Ter160anexoiiiInformeJustificativoDeLaCentralFrigorífica(data: dict):
    ...
    ss.nombre = "Ter160anexoiiiInformeJustificativoDeLaCentralFrigorífica"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter160anexoiiiInformeJustificativoDeLaCentralFrigorífica.pdf"
