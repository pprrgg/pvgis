...
@router.post('/Ter200')
def Ter200SustituciónDeAparatoDeRefrigeraciónConFunciónDeVentaDirecta(data: dict):
    ...
    ss.nombre = "Ter200SustituciónDeAparatoDeRefrigeraciónConFunciónDeVentaDirecta"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter200SustituciónDeAparatoDeRefrigeraciónConFunciónDeVentaDirecta.pdf"
