...
@router.post('/Ter174anexoiv')
def Ter174anexoivTablaDeCoeficientes1DeCoberturaPorBivalencia(data: dict):
    ...
    ss.nombre = "Ter174anexoivTablaDeCoeficientes1DeCoberturaPorBivalencia"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter174anexoivTablaDeCoeficientes1DeCoberturaPorBivalencia.pdf"
