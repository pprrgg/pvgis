...
@router.post('/Ter100anexovii')
def Ter100anexoviiCondicionesDeTemperaturaExteriorMedia(data: dict):
    ...
    ss.nombre = "Ter100anexoviiCondicionesDeTemperaturaExteriorMedia"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter100anexoviiCondicionesDeTemperaturaExteriorMedia.pdf"
