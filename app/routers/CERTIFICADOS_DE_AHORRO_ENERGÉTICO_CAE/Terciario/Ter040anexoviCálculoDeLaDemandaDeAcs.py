...
@router.post('/Ter040anexovi')
def Ter040anexoviCálculoDeLaDemandaDeAcs(data: dict):
    ...
    ss.nombre = "Ter040anexoviCálculoDeLaDemandaDeAcs"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter040anexoviCálculoDeLaDemandaDeAcs.pdf"
