...
@router.post('/Ter172anexoii')
def Ter172anexoiiFórmulasParaObtenerLosCoeficientesDe(data: dict):
    ...
    ss.nombre = "Ter172anexoiiFórmulasParaObtenerLosCoeficientesDe"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter172anexoiiFórmulasParaObtenerLosCoeficientesDe.pdf"
