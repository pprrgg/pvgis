...
@router.post('/Ter061anexoii')
def Ter061anexoiiValoresDelCoeficienteGSegúnZonaClimática(data: dict):
    ...
    ss.nombre = "Ter061anexoiiValoresDelCoeficienteGSegúnZonaClimática"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter061anexoiiValoresDelCoeficienteGSegúnZonaClimática.pdf"
