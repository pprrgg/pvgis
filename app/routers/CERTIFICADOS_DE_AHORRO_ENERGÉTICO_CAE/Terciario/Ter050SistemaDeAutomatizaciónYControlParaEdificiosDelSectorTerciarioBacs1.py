...
@router.post('/Ter050')
def Ter050SistemaDeAutomatizaciónYControlParaEdificiosDelSectorTerciarioBacs1(data: dict):
    ...
    ss.nombre = "Ter050SistemaDeAutomatizaciónYControlParaEdificiosDelSectorTerciarioBacs1"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter050SistemaDeAutomatizaciónYControlParaEdificiosDelSectorTerciarioBacs1.pdf"
