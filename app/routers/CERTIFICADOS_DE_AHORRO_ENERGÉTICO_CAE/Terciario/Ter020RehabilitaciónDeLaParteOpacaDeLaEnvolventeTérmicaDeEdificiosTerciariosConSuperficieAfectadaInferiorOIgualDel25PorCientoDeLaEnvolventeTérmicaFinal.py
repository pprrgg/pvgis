...
@router.post('/Ter020')
def Ter020RehabilitaciónDeLaParteOpacaDeLaEnvolventeTérmicaDeEdificiosTerciariosConSuperficieAfectadaInferiorOIgualDel25PorCientoDeLaEnvolventeTérmicaFinal(data: dict):
    ...
    ss.nombre = "Ter020RehabilitaciónDeLaParteOpacaDeLaEnvolventeTérmicaDeEdificiosTerciariosConSuperficieAfectadaInferiorOIgualDel25PorCientoDeLaEnvolventeTérmicaFinal"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter020RehabilitaciónDeLaParteOpacaDeLaEnvolventeTérmicaDeEdificiosTerciariosConSuperficieAfectadaInferiorOIgualDel25PorCientoDeLaEnvolventeTérmicaFinal.pdf"
