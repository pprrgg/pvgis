...
@router.post('/Ter061')
def Ter061RenovaciónOSustituciónDeVentanasEnEdificiosExistentesCanarias(data: dict):
    ...
    ss.nombre = "Ter061RenovaciónOSustituciónDeVentanasEnEdificiosExistentesCanarias"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter061RenovaciónOSustituciónDeVentanasEnEdificiosExistentesCanarias.pdf"
