...
@router.post('/Ter110')
def Ter110SustituciónDeCompresorParaInstalaciónFrigoríficaODeClimatización(data: dict):
    ...
    ss.nombre = "Ter110SustituciónDeCompresorParaInstalaciónFrigoríficaODeClimatización"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter110SustituciónDeCompresorParaInstalaciónFrigoríficaODeClimatización.pdf"
