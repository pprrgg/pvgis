...
@router.post('/Ter176anexoiii')
def Ter176anexoiiiCondicionesGeneralesParaCálculoDeLa(data: dict):
    ...
    ss.nombre = "Ter176anexoiiiCondicionesGeneralesParaCálculoDeLa"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter176anexoiiiCondicionesGeneralesParaCálculoDeLa.pdf"
