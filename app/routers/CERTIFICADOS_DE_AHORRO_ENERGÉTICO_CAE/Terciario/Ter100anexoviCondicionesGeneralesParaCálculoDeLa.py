...
@router.post('/Ter100anexovi')
def Ter100anexoviCondicionesGeneralesParaCálculoDeLa(data: dict):
    ...
    ss.nombre = "Ter100anexoviCondicionesGeneralesParaCálculoDeLa"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter100anexoviCondicionesGeneralesParaCálculoDeLa.pdf"
