...
@router.post('/Ter173anexoiii')
def Ter173anexoiiiCondicionesGeneralesParaCálculoDeLa(data: dict):
    ...
    ss.nombre = "Ter173anexoiiiCondicionesGeneralesParaCálculoDeLa"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter173anexoiiiCondicionesGeneralesParaCálculoDeLa.pdf"
