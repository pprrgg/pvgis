...
@router.post('/Ter060anexoii')
def Ter060anexoiiValoresDelCoeficienteGSegúnZonaClimática(data: dict):
    ...
    ss.nombre = "Ter060anexoiiValoresDelCoeficienteGSegúnZonaClimática"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter060anexoiiValoresDelCoeficienteGSegúnZonaClimática.pdf"
