...
@router.post('/Ter240')
def Ter240ImplantaciónDeVariadorDeVelocidad(data: dict):
    ...
    ss.nombre = "Ter240ImplantaciónDeVariadorDeVelocidad"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter240ImplantaciónDeVariadorDeVelocidad.pdf"
