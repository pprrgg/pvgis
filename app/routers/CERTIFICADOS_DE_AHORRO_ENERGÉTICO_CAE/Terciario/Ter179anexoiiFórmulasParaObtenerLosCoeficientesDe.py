...
@router.post('/Ter179anexoii')
def Ter179anexoiiFórmulasParaObtenerLosCoeficientesDe(data: dict):
    ...
    ss.nombre = "Ter179anexoiiFórmulasParaObtenerLosCoeficientesDe"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter179anexoiiFórmulasParaObtenerLosCoeficientesDe.pdf"
