...
@router.post('/Ter173anexoiv')
def Ter173anexoivTablaDeCoeficientes1DeCoberturaPorBivalencia(data: dict):
    ...
    ss.nombre = "Ter173anexoivTablaDeCoeficientes1DeCoberturaPorBivalencia"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter173anexoivTablaDeCoeficientes1DeCoberturaPorBivalencia.pdf"
