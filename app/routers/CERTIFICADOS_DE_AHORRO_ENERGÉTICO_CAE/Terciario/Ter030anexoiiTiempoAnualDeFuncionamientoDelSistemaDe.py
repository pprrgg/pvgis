...
@router.post('/Ter030anexoii')
def Ter030anexoiiTiempoAnualDeFuncionamientoDelSistemaDe(data: dict):
    ...
    ss.nombre = "Ter030anexoiiTiempoAnualDeFuncionamientoDelSistemaDe"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter030anexoiiTiempoAnualDeFuncionamientoDelSistemaDe.pdf"
