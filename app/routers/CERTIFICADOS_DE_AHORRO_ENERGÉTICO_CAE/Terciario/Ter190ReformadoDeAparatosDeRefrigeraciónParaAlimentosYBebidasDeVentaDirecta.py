...
@router.post('/Ter190')
def Ter190ReformadoDeAparatosDeRefrigeraciónParaAlimentosYBebidasDeVentaDirecta(data: dict):
    ...
    ss.nombre = "Ter190ReformadoDeAparatosDeRefrigeraciónParaAlimentosYBebidasDeVentaDirecta"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter190ReformadoDeAparatosDeRefrigeraciónParaAlimentosYBebidasDeVentaDirecta.pdf"
