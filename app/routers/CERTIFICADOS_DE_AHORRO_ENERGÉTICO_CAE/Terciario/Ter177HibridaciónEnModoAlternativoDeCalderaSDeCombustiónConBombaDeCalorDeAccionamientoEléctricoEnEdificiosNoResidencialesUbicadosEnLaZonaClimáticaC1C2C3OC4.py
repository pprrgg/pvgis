...
@router.post('/Ter177')
def Ter177HibridaciónEnModoAlternativoDeCalderaSDeCombustiónConBombaDeCalorDeAccionamientoEléctricoEnEdificiosNoResidencialesUbicadosEnLaZonaClimáticaC1C2C3OC4(data: dict):
    ...
    ss.nombre = "Ter177HibridaciónEnModoAlternativoDeCalderaSDeCombustiónConBombaDeCalorDeAccionamientoEléctricoEnEdificiosNoResidencialesUbicadosEnLaZonaClimáticaC1C2C3OC4"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter177HibridaciónEnModoAlternativoDeCalderaSDeCombustiónConBombaDeCalorDeAccionamientoEléctricoEnEdificiosNoResidencialesUbicadosEnLaZonaClimáticaC1C2C3OC4.pdf"
