...
@router.post('/Ter140anexoii')
def Ter140anexoiiValoresDeReferenciaDeLaFórmula(data: dict):
    ...
    ss.nombre = "Ter140anexoiiValoresDeReferenciaDeLaFórmula"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter140anexoiiValoresDeReferenciaDeLaFórmula.pdf"
