...
@router.post('/Ter179anexoiii')
def Ter179anexoiiiCondicionesGeneralesParaCálculoDeLa(data: dict):
    ...
    ss.nombre = "Ter179anexoiiiCondicionesGeneralesParaCálculoDeLa"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter179anexoiiiCondicionesGeneralesParaCálculoDeLa.pdf"
