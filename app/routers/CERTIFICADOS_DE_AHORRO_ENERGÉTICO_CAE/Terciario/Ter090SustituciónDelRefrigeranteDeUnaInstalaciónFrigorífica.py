...
@router.post('/Ter090')
def Ter090SustituciónDelRefrigeranteDeUnaInstalaciónFrigorífica(data: dict):
    ...
    ss.nombre = "Ter090SustituciónDelRefrigeranteDeUnaInstalaciónFrigorífica"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter090SustituciónDelRefrigeranteDeUnaInstalaciónFrigorífica.pdf"
