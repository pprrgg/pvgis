...
@router.post('/Ter110anexoii')
def Ter110anexoiiValoresDeReferenciaDeLaFórmula(data: dict):
    ...
    ss.nombre = "Ter110anexoiiValoresDeReferenciaDeLaFórmula"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter110anexoiiValoresDeReferenciaDeLaFórmula.pdf"
