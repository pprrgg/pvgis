...
@router.post('/Ter040anexovii')
def Ter040anexoviiCondicionesConsideradasEnAcs(data: dict):
    ...
    ss.nombre = "Ter040anexoviiCondicionesConsideradasEnAcs"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter040anexoviiCondicionesConsideradasEnAcs.pdf"
