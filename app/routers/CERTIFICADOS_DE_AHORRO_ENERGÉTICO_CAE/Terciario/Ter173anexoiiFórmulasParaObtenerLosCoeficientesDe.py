...
@router.post('/Ter173anexoii')
def Ter173anexoiiFórmulasParaObtenerLosCoeficientesDe(data: dict):
    ...
    ss.nombre = "Ter173anexoiiFórmulasParaObtenerLosCoeficientesDe"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter173anexoiiFórmulasParaObtenerLosCoeficientesDe.pdf"
