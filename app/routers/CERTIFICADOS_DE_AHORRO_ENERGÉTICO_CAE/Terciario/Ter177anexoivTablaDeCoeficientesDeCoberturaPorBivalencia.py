...
@router.post('/Ter177anexoiv')
def Ter177anexoivTablaDeCoeficientesDeCoberturaPorBivalencia(data: dict):
    ...
    ss.nombre = "Ter177anexoivTablaDeCoeficientesDeCoberturaPorBivalencia"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter177anexoivTablaDeCoeficientesDeCoberturaPorBivalencia.pdf"
