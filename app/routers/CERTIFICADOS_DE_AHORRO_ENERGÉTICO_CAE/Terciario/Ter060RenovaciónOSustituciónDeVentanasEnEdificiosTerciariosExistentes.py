...
@router.post('/Ter060')
def Ter060RenovaciónOSustituciónDeVentanasEnEdificiosTerciariosExistentes(data: dict):
    ...
    ss.nombre = "Ter060RenovaciónOSustituciónDeVentanasEnEdificiosTerciariosExistentes"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter060RenovaciónOSustituciónDeVentanasEnEdificiosTerciariosExistentes.pdf"
