...
@router.post('/Ter011')
def Ter011RehabilitaciónDeLaEnvolventeTérmicaDeEdificiosTerciariosExistentesConSuperficieAfectadaMayorDel25PorCientoCanarias(data: dict):
    ...
    ss.nombre = "Ter011RehabilitaciónDeLaEnvolventeTérmicaDeEdificiosTerciariosExistentesConSuperficieAfectadaMayorDel25PorCientoCanarias"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter011RehabilitaciónDeLaEnvolventeTérmicaDeEdificiosTerciariosExistentesConSuperficieAfectadaMayorDel25PorCientoCanarias.pdf"
