...
@router.post('/Ter070')
def Ter070NuevaImplantaciónSustituciónOAmpliaciónDeInstalaciónTérmicaEnUnEdificioYPiscinaConTecnologíaSolarTérmica(data: dict):
    ...
    ss.nombre = "Ter070NuevaImplantaciónSustituciónOAmpliaciónDeInstalaciónTérmicaEnUnEdificioYPiscinaConTecnologíaSolarTérmica"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter070NuevaImplantaciónSustituciónOAmpliaciónDeInstalaciónTérmicaEnUnEdificioYPiscinaConTecnologíaSolarTérmica.pdf"
