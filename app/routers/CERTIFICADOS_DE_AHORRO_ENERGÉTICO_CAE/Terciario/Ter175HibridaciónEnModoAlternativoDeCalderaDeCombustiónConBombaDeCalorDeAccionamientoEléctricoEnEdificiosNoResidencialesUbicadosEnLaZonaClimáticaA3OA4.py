...
@router.post('/Ter175')
def Ter175HibridaciónEnModoAlternativoDeCalderaDeCombustiónConBombaDeCalorDeAccionamientoEléctricoEnEdificiosNoResidencialesUbicadosEnLaZonaClimáticaA3OA4(data: dict):
    ...
    ss.nombre = "Ter175HibridaciónEnModoAlternativoDeCalderaDeCombustiónConBombaDeCalorDeAccionamientoEléctricoEnEdificiosNoResidencialesUbicadosEnLaZonaClimáticaA3OA4"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter175HibridaciónEnModoAlternativoDeCalderaDeCombustiónConBombaDeCalorDeAccionamientoEléctricoEnEdificiosNoResidencialesUbicadosEnLaZonaClimáticaA3OA4.pdf"
