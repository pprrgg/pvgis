...
@router.post('/Ter172anexoiv')
def Ter172anexoivTablaDeCoeficientes1DeCoberturaPorBivalencia(data: dict):
    ...
    ss.nombre = "Ter172anexoivTablaDeCoeficientes1DeCoberturaPorBivalencia"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter172anexoivTablaDeCoeficientes1DeCoberturaPorBivalencia.pdf"
