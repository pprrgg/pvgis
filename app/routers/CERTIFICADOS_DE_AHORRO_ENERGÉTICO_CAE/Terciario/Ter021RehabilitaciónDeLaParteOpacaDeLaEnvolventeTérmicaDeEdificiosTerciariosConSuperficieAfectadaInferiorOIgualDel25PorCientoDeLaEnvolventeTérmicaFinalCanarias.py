...
@router.post('/Ter021')
def Ter021RehabilitaciónDeLaParteOpacaDeLaEnvolventeTérmicaDeEdificiosTerciariosConSuperficieAfectadaInferiorOIgualDel25PorCientoDeLaEnvolventeTérmicaFinalCanarias(data: dict):
    ...
    ss.nombre = "Ter021RehabilitaciónDeLaParteOpacaDeLaEnvolventeTérmicaDeEdificiosTerciariosConSuperficieAfectadaInferiorOIgualDel25PorCientoDeLaEnvolventeTérmicaFinalCanarias"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter021RehabilitaciónDeLaParteOpacaDeLaEnvolventeTérmicaDeEdificiosTerciariosConSuperficieAfectadaInferiorOIgualDel25PorCientoDeLaEnvolventeTérmicaFinalCanarias.pdf"
