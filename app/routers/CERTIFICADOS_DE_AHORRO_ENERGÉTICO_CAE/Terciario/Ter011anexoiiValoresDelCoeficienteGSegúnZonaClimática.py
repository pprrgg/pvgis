...
@router.post('/Ter011anexoii')
def Ter011anexoiiValoresDelCoeficienteGSegúnZonaClimática(data: dict):
    ...
    ss.nombre = "Ter011anexoiiValoresDelCoeficienteGSegúnZonaClimática"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter011anexoiiValoresDelCoeficienteGSegúnZonaClimática.pdf"
