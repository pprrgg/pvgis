...
@router.post('/Ter178anexoiii')
def Ter178anexoiiiCondicionesGeneralesParaCálculoDeLa(data: dict):
    ...
    ss.nombre = "Ter178anexoiiiCondicionesGeneralesParaCálculoDeLa"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter178anexoiiiCondicionesGeneralesParaCálculoDeLa.pdf"
