...
@router.post('/Ter174')
def Ter174HibridaciónEnModoParaleloDeCalderaSDeCombustiónConBombaDeCalorDeAccionamientoEléctricoEnEdificiosNoResidencialesUbicadosEnLaZonaClimáticaE1(data: dict):
    ...
    ss.nombre = "Ter174HibridaciónEnModoParaleloDeCalderaSDeCombustiónConBombaDeCalorDeAccionamientoEléctricoEnEdificiosNoResidencialesUbicadosEnLaZonaClimáticaE1"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Terciario/Ter174HibridaciónEnModoParaleloDeCalderaSDeCombustiónConBombaDeCalorDeAccionamientoEléctricoEnEdificiosNoResidencialesUbicadosEnLaZonaClimáticaE1.pdf"
