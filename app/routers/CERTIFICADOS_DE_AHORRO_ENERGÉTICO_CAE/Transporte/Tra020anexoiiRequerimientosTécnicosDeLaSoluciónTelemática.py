...
@router.post('/Tra020anexoii')
def Tra020anexoiiRequerimientosTécnicosDeLaSoluciónTelemática(data: dict):
    ...
    ss.nombre = "Tra020anexoiiRequerimientosTécnicosDeLaSoluciónTelemática"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Transporte/Tra020anexoiiRequerimientosTécnicosDeLaSoluciónTelemática.pdf"
