...
@router.post('/Tra030')
def Tra030VehículoCompartidoEnTrayectosDeLargoRecorrido(data: dict):
    ...
    ss.nombre = "Tra030VehículoCompartidoEnTrayectosDeLargoRecorrido"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Transporte/Tra030VehículoCompartidoEnTrayectosDeLargoRecorrido.pdf"
