...
@router.post('/Tra040anexoiii')
def Tra040anexoiiiCriteriosAntifraudeParaLaCorrecta(data: dict):
    ...
    ss.nombre = "Tra040anexoiiiCriteriosAntifraudeParaLaCorrecta"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Transporte/Tra040anexoiiiCriteriosAntifraudeParaLaCorrecta.pdf"
