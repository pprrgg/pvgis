...
@router.post('/Tra030anexoiii')
def Tra030anexoiiiCriteriosAntifraudeParaLaCorrecta(data: dict):
    ...
    ss.nombre = "Tra030anexoiiiCriteriosAntifraudeParaLaCorrecta"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Transporte/Tra030anexoiiiCriteriosAntifraudeParaLaCorrecta.pdf"
