...
@router.post('/Tra010anexoi')
def Tra010anexoiDeclaraciónResponsableFormalizadaPorEl(data: dict):
    ...
    ss.nombre = "Tra010anexoiDeclaraciónResponsableFormalizadaPorEl"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Transporte/Tra010anexoiDeclaraciónResponsableFormalizadaPorEl.pdf"
