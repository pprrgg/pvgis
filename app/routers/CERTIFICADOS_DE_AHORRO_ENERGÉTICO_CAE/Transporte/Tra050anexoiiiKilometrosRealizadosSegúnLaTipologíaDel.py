...
@router.post('/Tra050anexoiii')
def Tra050anexoiiiKilometrosRealizadosSegúnLaTipologíaDel(data: dict):
    ...
    ss.nombre = "Tra050anexoiiiKilometrosRealizadosSegúnLaTipologíaDel"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Transporte/Tra050anexoiiiKilometrosRealizadosSegúnLaTipologíaDel.pdf"
