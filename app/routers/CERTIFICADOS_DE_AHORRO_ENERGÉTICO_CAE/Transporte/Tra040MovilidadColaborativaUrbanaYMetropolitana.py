...
@router.post('/Tra040')
def Tra040MovilidadColaborativaUrbanaYMetropolitana(data: dict):
    ...
    ss.nombre = "Tra040MovilidadColaborativaUrbanaYMetropolitana"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Transporte/Tra040MovilidadColaborativaUrbanaYMetropolitana.pdf"
