...
@router.post('/Tra010anexoiii')
def Tra010anexoiiiKilometrosRealizadosSegúnLaTipologíaDel(data: dict):
    ...
    ss.nombre = "Tra010anexoiiiKilometrosRealizadosSegúnLaTipologíaDel"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Transporte/Tra010anexoiiiKilometrosRealizadosSegúnLaTipologíaDel.pdf"
