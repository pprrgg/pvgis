...
@router.post('/Tra040anexoii')
def Tra040anexoiiRequisitosParaLaAplicaciónDeLaFicha(data: dict):
    ...
    ss.nombre = "Tra040anexoiiRequisitosParaLaAplicaciónDeLaFicha"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Transporte/Tra040anexoiiRequisitosParaLaAplicaciónDeLaFicha.pdf"
