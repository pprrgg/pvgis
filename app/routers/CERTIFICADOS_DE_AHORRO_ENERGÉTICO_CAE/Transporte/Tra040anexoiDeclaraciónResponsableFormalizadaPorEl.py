...
@router.post('/Tra040anexoi')
def Tra040anexoiDeclaraciónResponsableFormalizadaPorEl(data: dict):
    ...
    ss.nombre = "Tra040anexoiDeclaraciónResponsableFormalizadaPorEl"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Transporte/Tra040anexoiDeclaraciónResponsableFormalizadaPorEl.pdf"
