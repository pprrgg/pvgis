...
@router.post('/Tra030anexoii')
def Tra030anexoiiRequisitosParaLaAplicaciónDeLaFicha(data: dict):
    ...
    ss.nombre = "Tra030anexoiiRequisitosParaLaAplicaciónDeLaFicha"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Transporte/Tra030anexoiiRequisitosParaLaAplicaciónDeLaFicha.pdf"
