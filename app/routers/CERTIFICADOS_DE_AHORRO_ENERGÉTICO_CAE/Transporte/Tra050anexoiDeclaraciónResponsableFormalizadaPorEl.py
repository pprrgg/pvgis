...
@router.post('/Tra050anexoi')
def Tra050anexoiDeclaraciónResponsableFormalizadaPorEl(data: dict):
    ...
    ss.nombre = "Tra050anexoiDeclaraciónResponsableFormalizadaPorEl"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Transporte/Tra050anexoiDeclaraciónResponsableFormalizadaPorEl.pdf"
