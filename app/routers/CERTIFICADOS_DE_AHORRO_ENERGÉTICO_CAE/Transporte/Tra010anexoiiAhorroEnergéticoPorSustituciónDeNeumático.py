...
@router.post('/Tra010anexoii')
def Tra010anexoiiAhorroEnergéticoPorSustituciónDeNeumático(data: dict):
    ...
    ss.nombre = "Tra010anexoiiAhorroEnergéticoPorSustituciónDeNeumático"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Transporte/Tra010anexoiiAhorroEnergéticoPorSustituciónDeNeumático.pdf"
