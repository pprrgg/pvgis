...
@router.post('/Tra050anexoii')
def Tra050anexoiiMétodosParaObtenerLosConsumosDeVehículos(data: dict):
    ...
    ss.nombre = "Tra050anexoiiMétodosParaObtenerLosConsumosDeVehículos"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Transporte/Tra050anexoiiMétodosParaObtenerLosConsumosDeVehículos.pdf"
