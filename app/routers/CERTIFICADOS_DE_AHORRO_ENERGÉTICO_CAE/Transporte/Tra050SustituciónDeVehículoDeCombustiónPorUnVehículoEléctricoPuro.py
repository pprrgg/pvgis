...
@router.post('/Tra050')
def Tra050SustituciónDeVehículoDeCombustiónPorUnVehículoEléctricoPuro(data: dict):
    ...
    ss.nombre = "Tra050SustituciónDeVehículoDeCombustiónPorUnVehículoEléctricoPuro"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Transporte/Tra050SustituciónDeVehículoDeCombustiónPorUnVehículoEléctricoPuro.pdf"
