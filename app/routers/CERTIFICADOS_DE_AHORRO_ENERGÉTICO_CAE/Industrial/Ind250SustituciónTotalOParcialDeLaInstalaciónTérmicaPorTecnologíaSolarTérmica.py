...
@router.post('/Ind250')
def Ind250SustituciónTotalOParcialDeLaInstalaciónTérmicaPorTecnologíaSolarTérmica(data: dict):
    ...
    ss.nombre = "Ind250SustituciónTotalOParcialDeLaInstalaciónTérmicaPorTecnologíaSolarTérmica"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind250SustituciónTotalOParcialDeLaInstalaciónTérmicaPorTecnologíaSolarTérmica.pdf"
