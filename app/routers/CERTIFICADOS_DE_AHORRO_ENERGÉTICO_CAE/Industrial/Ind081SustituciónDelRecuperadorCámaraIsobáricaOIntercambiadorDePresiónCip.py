...
@router.post('/Ind081')
def Ind081SustituciónDelRecuperadorCámaraIsobáricaOIntercambiadorDePresiónCip(data: dict):
    ...
    ss.nombre = "Ind081SustituciónDelRecuperadorCámaraIsobáricaOIntercambiadorDePresiónCip"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind081SustituciónDelRecuperadorCámaraIsobáricaOIntercambiadorDePresiónCip.pdf"
