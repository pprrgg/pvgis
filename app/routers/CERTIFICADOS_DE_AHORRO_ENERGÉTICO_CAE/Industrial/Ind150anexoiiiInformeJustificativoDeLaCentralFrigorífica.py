...
@router.post('/Ind150anexoiii')
def Ind150anexoiiiInformeJustificativoDeLaCentralFrigorífica(data: dict):
    ...
    ss.nombre = "Ind150anexoiiiInformeJustificativoDeLaCentralFrigorífica"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind150anexoiiiInformeJustificativoDeLaCentralFrigorífica.pdf"
