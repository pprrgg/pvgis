...
@router.post('/Ind200')
def Ind200ImplantaciónDeSistemasEconomizadoresOMultietapaEnInstalaciónFrigoríficaCentralizadaOCompacta(data: dict):
    ...
    ss.nombre = "Ind200ImplantaciónDeSistemasEconomizadoresOMultietapaEnInstalaciónFrigoríficaCentralizadaOCompacta"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind200ImplantaciónDeSistemasEconomizadoresOMultietapaEnInstalaciónFrigoríficaCentralizadaOCompacta.pdf"
