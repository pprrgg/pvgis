...
@router.post('/Ind010anexoiv')
def Ind010anexoivPérdidasTérmicasObjetivoDeAcuerdoCon(data: dict):
    ...
    ss.nombre = "Ind010anexoivPérdidasTérmicasObjetivoDeAcuerdoCon"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind010anexoivPérdidasTérmicasObjetivoDeAcuerdoCon.pdf"
