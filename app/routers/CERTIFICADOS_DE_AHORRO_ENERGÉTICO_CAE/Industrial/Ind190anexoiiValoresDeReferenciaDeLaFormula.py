...
@router.post('/Ind190anexoii')
def Ind190anexoiiValoresDeReferenciaDeLaFormula(data: dict):
    ...
    ss.nombre = "Ind190anexoiiValoresDeReferenciaDeLaFormula"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind190anexoiiValoresDeReferenciaDeLaFormula.pdf"
