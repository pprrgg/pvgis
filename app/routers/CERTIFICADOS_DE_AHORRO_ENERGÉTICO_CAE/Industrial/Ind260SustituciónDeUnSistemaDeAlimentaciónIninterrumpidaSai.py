...
@router.post('/Ind260')
def Ind260SustituciónDeUnSistemaDeAlimentaciónIninterrumpidaSai(data: dict):
    ...
    ss.nombre = "Ind260SustituciónDeUnSistemaDeAlimentaciónIninterrumpidaSai"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind260SustituciónDeUnSistemaDeAlimentaciónIninterrumpidaSai.pdf"
