...
@router.post('/Ind140')
def Ind140ReformaSustituciónONuevaInstalaciónDePlantaEnfriadoraDeProcesosDeAltaEficiencia(data: dict):
    ...
    ss.nombre = "Ind140ReformaSustituciónONuevaInstalaciónDePlantaEnfriadoraDeProcesosDeAltaEficiencia"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind140ReformaSustituciónONuevaInstalaciónDePlantaEnfriadoraDeProcesosDeAltaEficiencia.pdf"
