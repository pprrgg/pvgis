...
@router.post('/Ind020')
def Ind020SustituciónDelRefrigeranteDeUnaInstalaciónFrigorífica(data: dict):
    ...
    ss.nombre = "Ind020SustituciónDelRefrigeranteDeUnaInstalaciónFrigorífica"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind020SustituciónDelRefrigeranteDeUnaInstalaciónFrigorífica.pdf"
