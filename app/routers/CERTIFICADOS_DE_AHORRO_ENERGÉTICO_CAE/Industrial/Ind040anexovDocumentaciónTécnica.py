...
@router.post('/Ind040anexov')
def Ind040anexovDocumentaciónTécnica(data: dict):
    ...
    ss.nombre = "Ind040anexovDocumentaciónTécnica"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind040anexovDocumentaciónTécnica.pdf"
