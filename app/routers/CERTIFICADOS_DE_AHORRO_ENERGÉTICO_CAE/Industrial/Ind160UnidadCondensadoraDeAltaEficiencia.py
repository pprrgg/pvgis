...
@router.post('/Ind160')
def Ind160UnidadCondensadoraDeAltaEficiencia(data: dict):
    ...
    ss.nombre = "Ind160UnidadCondensadoraDeAltaEficiencia"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind160UnidadCondensadoraDeAltaEficiencia.pdf"
