...
@router.post('/Ind210anexoiii')
def Ind210anexoiiiInformeJustificativoDeLaCentralFrigorífica(data: dict):
    ...
    ss.nombre = "Ind210anexoiiiInformeJustificativoDeLaCentralFrigorífica"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind210anexoiiiInformeJustificativoDeLaCentralFrigorífica.pdf"
