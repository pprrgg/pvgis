...
@router.post('/Ind040anexoiii')
def Ind040anexoiiiDemandaAnualDeEnergíaParaAcs(data: dict):
    ...
    ss.nombre = "Ind040anexoiiiDemandaAnualDeEnergíaParaAcs"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind040anexoiiiDemandaAnualDeEnergíaParaAcs.pdf"
