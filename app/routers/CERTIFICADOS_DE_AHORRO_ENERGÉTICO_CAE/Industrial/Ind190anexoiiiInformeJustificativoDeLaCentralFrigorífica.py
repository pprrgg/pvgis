...
@router.post('/Ind190anexoiii')
def Ind190anexoiiiInformeJustificativoDeLaCentralFrigorífica(data: dict):
    ...
    ss.nombre = "Ind190anexoiiiInformeJustificativoDeLaCentralFrigorífica"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind190anexoiiiInformeJustificativoDeLaCentralFrigorífica.pdf"
