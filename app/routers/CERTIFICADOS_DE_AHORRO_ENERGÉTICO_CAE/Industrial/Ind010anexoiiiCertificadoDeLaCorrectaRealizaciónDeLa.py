...
@router.post('/Ind010anexoiii')
def Ind010anexoiiiCertificadoDeLaCorrectaRealizaciónDeLa(data: dict):
    ...
    ss.nombre = "Ind010anexoiiiCertificadoDeLaCorrectaRealizaciónDeLa"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind010anexoiiiCertificadoDeLaCorrectaRealizaciónDeLa.pdf"
