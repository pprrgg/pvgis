...
@router.post('/Ind030')
def Ind030SustituciónDeCompresorParaInstalaciónFrigorífica(data: dict):
    ...
    ss.nombre = "Ind030SustituciónDeCompresorParaInstalaciónFrigorífica"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind030SustituciónDeCompresorParaInstalaciónFrigorífica.pdf"
