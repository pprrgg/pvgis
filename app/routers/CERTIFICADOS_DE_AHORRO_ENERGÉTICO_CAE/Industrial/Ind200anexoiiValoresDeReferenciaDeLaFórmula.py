...
@router.post('/Ind200anexoii')
def Ind200anexoiiValoresDeReferenciaDeLaFórmula(data: dict):
    ...
    ss.nombre = "Ind200anexoiiValoresDeReferenciaDeLaFórmula"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind200anexoiiValoresDeReferenciaDeLaFórmula.pdf"
