...
@router.post('/Ind240')
def Ind240ImplantaciónDeVariadorDeVelocidad(data: dict):
    ...
    ss.nombre = "Ind240ImplantaciónDeVariadorDeVelocidad"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind240ImplantaciónDeVariadorDeVelocidad.pdf"
