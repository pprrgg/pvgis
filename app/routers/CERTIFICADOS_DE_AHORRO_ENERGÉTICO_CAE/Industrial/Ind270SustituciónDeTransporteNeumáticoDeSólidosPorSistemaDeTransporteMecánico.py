...
@router.post('/Ind270')
def Ind270SustituciónDeTransporteNeumáticoDeSólidosPorSistemaDeTransporteMecánico(data: dict):
    ...
    ss.nombre = "Ind270SustituciónDeTransporteNeumáticoDeSólidosPorSistemaDeTransporteMecánico"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind270SustituciónDeTransporteNeumáticoDeSólidosPorSistemaDeTransporteMecánico.pdf"
