...
@router.post('/Ind280')
def Ind280SustituciónDeBombaPorOtraMásEficiente(data: dict):
    ...
    ss.nombre = "Ind280SustituciónDeBombaPorOtraMásEficiente"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind280SustituciónDeBombaPorOtraMásEficiente.pdf"
