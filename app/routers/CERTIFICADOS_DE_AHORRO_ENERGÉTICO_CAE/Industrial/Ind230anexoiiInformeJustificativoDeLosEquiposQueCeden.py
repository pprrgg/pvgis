...
@router.post('/Ind230anexoii')
def Ind230anexoiiInformeJustificativoDeLosEquiposQueCeden(data: dict):
    ...
    ss.nombre = "Ind230anexoiiInformeJustificativoDeLosEquiposQueCeden"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind230anexoiiInformeJustificativoDeLosEquiposQueCeden.pdf"
