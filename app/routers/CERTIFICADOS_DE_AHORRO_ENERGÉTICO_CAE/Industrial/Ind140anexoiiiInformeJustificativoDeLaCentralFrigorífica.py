...
@router.post('/Ind140anexoiii')
def Ind140anexoiiiInformeJustificativoDeLaCentralFrigorífica(data: dict):
    ...
    ss.nombre = "Ind140anexoiiiInformeJustificativoDeLaCentralFrigorífica"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind140anexoiiiInformeJustificativoDeLaCentralFrigorífica.pdf"
