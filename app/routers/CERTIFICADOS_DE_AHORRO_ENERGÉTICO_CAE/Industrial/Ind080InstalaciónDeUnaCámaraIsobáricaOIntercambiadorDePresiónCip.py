...
@router.post('/Ind080')
def Ind080InstalaciónDeUnaCámaraIsobáricaOIntercambiadorDePresiónCip(data: dict):
    ...
    ss.nombre = "Ind080InstalaciónDeUnaCámaraIsobáricaOIntercambiadorDePresiónCip"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind080InstalaciónDeUnaCámaraIsobáricaOIntercambiadorDePresiónCip.pdf"
