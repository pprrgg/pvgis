...
@router.post('/Ind110')
def Ind110RecuperaciónDeCalorDeUnCompresorParaUsoDeCalefacción(data: dict):
    ...
    ss.nombre = "Ind110RecuperaciónDeCalorDeUnCompresorParaUsoDeCalefacción"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind110RecuperaciónDeCalorDeUnCompresorParaUsoDeCalefacción.pdf"
