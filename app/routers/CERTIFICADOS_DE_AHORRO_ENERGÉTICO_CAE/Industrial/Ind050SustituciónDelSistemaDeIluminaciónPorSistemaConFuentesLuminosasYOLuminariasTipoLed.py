...
@router.post('/Ind050')
def Ind050SustituciónDelSistemaDeIluminaciónPorSistemaConFuentesLuminosasYOLuminariasTipoLed(data: dict):
    ...
    ss.nombre = "Ind050SustituciónDelSistemaDeIluminaciónPorSistemaConFuentesLuminosasYOLuminariasTipoLed"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind050SustituciónDelSistemaDeIluminaciónPorSistemaConFuentesLuminosasYOLuminariasTipoLed.pdf"
