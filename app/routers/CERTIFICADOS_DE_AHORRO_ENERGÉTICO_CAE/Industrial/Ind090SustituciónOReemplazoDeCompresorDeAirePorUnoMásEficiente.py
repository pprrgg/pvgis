...
@router.post('/Ind090')
def Ind090SustituciónOReemplazoDeCompresorDeAirePorUnoMásEficiente(data: dict):
    ...
    ss.nombre = "Ind090SustituciónOReemplazoDeCompresorDeAirePorUnoMásEficiente"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind090SustituciónOReemplazoDeCompresorDeAirePorUnoMásEficiente.pdf"
