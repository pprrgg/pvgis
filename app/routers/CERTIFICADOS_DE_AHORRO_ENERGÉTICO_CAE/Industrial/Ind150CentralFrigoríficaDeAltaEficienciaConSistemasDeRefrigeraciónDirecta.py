...
@router.post('/Ind150')
def Ind150CentralFrigoríficaDeAltaEficienciaConSistemasDeRefrigeraciónDirecta(data: dict):
    ...
    ss.nombre = "Ind150CentralFrigoríficaDeAltaEficienciaConSistemasDeRefrigeraciónDirecta"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind150CentralFrigoríficaDeAltaEficienciaConSistemasDeRefrigeraciónDirecta.pdf"
