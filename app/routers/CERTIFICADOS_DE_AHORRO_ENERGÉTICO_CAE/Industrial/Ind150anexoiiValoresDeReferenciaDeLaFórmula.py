...
@router.post('/Ind150anexoii')
def Ind150anexoiiValoresDeReferenciaDeLaFórmula(data: dict):
    ...
    ss.nombre = "Ind150anexoiiValoresDeReferenciaDeLaFórmula"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind150anexoiiValoresDeReferenciaDeLaFórmula.pdf"
