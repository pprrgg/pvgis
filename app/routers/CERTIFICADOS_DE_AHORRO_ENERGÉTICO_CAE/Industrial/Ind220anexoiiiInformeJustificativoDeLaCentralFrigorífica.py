...
@router.post('/Ind220anexoiii')
def Ind220anexoiiiInformeJustificativoDeLaCentralFrigorífica(data: dict):
    ...
    ss.nombre = "Ind220anexoiiiInformeJustificativoDeLaCentralFrigorífica"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind220anexoiiiInformeJustificativoDeLaCentralFrigorífica.pdf"
