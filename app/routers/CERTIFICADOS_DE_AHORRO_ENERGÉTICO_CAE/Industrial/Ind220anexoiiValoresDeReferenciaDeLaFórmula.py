...
@router.post('/Ind220anexoii')
def Ind220anexoiiValoresDeReferenciaDeLaFórmula(data: dict):
    ...
    ss.nombre = "Ind220anexoiiValoresDeReferenciaDeLaFórmula"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind220anexoiiValoresDeReferenciaDeLaFórmula.pdf"
