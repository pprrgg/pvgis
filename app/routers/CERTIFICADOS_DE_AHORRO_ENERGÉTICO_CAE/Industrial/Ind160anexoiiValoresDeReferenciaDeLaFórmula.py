...
@router.post('/Ind160anexoii')
def Ind160anexoiiValoresDeReferenciaDeLaFórmula(data: dict):
    ...
    ss.nombre = "Ind160anexoiiValoresDeReferenciaDeLaFórmula"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind160anexoiiValoresDeReferenciaDeLaFórmula.pdf"
