...
@router.post('/Ind140anexoii')
def Ind140anexoiiValoresDeReferenciaDeLaFórmula(data: dict):
    ...
    ss.nombre = "Ind140anexoiiValoresDeReferenciaDeLaFórmula"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind140anexoiiValoresDeReferenciaDeLaFórmula.pdf"
