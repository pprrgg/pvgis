...
@router.post('/Ind260anexoii')
def Ind260anexoiiDeclaraciónResponsablePorLaEmpresa(data: dict):
    ...
    ss.nombre = "Ind260anexoiiDeclaraciónResponsablePorLaEmpresa"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind260anexoiiDeclaraciónResponsablePorLaEmpresa.pdf"
