...
@router.post('/Ind020anexoiii')
def Ind020anexoiiiNotaInformativaAcercaDeLaSustituciónDe(data: dict):
    ...
    ss.nombre = "Ind020anexoiiiNotaInformativaAcercaDeLaSustituciónDe"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind020anexoiiiNotaInformativaAcercaDeLaSustituciónDe.pdf"
