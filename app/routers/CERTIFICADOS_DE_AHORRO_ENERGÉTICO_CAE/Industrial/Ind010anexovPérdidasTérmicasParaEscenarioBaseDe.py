...
@router.post('/Ind010anexov')
def Ind010anexovPérdidasTérmicasParaEscenarioBaseDe(data: dict):
    ...
    ss.nombre = "Ind010anexovPérdidasTérmicasParaEscenarioBaseDe"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind010anexovPérdidasTérmicasParaEscenarioBaseDe.pdf"
