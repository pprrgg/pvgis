...
@router.post('/Ind060anexoii')
def Ind060anexoiiCálculoDelRendimientoEstacionalDeEquipos(data: dict):
    ...
    ss.nombre = "Ind060anexoiiCálculoDelRendimientoEstacionalDeEquipos"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind060anexoiiCálculoDelRendimientoEstacionalDeEquipos.pdf"
