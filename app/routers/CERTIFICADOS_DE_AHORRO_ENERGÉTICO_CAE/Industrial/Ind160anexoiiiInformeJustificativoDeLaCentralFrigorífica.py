...
@router.post('/Ind160anexoiii')
def Ind160anexoiiiInformeJustificativoDeLaCentralFrigorífica(data: dict):
    ...
    ss.nombre = "Ind160anexoiiiInformeJustificativoDeLaCentralFrigorífica"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind160anexoiiiInformeJustificativoDeLaCentralFrigorífica.pdf"
