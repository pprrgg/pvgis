...
@router.post('/Ind120')
def Ind120SustituciónDeQuemadorModulanteDeCalderaDeCombustiónDeGas(data: dict):
    ...
    ss.nombre = "Ind120SustituciónDeQuemadorModulanteDeCalderaDeCombustiónDeGas"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind120SustituciónDeQuemadorModulanteDeCalderaDeCombustiónDeGas.pdf"
