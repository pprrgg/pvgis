...
@router.post('/Ind010anexoii')
def Ind010anexoiiInformeJustificativoDeLaInstalaciónObjetoDe(data: dict):
    ...
    ss.nombre = "Ind010anexoiiInformeJustificativoDeLaInstalaciónObjetoDe"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind010anexoiiInformeJustificativoDeLaInstalaciónObjetoDe.pdf"
