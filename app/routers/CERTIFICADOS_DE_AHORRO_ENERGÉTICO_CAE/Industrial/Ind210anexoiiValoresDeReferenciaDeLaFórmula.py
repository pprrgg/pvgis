...
@router.post('/Ind210anexoii')
def Ind210anexoiiValoresDeReferenciaDeLaFórmula(data: dict):
    ...
    ss.nombre = "Ind210anexoiiValoresDeReferenciaDeLaFórmula"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind210anexoiiValoresDeReferenciaDeLaFórmula.pdf"
