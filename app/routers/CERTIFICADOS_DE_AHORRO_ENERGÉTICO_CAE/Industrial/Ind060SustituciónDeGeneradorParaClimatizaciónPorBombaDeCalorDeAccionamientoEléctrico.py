...
@router.post('/Ind060')
def Ind060SustituciónDeGeneradorParaClimatizaciónPorBombaDeCalorDeAccionamientoEléctrico(data: dict):
    ...
    ss.nombre = "Ind060SustituciónDeGeneradorParaClimatizaciónPorBombaDeCalorDeAccionamientoEléctrico"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind060SustituciónDeGeneradorParaClimatizaciónPorBombaDeCalorDeAccionamientoEléctrico.pdf"
