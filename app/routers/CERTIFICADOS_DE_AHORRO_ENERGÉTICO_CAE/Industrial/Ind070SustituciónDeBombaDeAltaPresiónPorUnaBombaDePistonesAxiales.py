...
@router.post('/Ind070')
def Ind070SustituciónDeBombaDeAltaPresiónPorUnaBombaDePistonesAxiales(data: dict):
    ...
    ss.nombre = "Ind070SustituciónDeBombaDeAltaPresiónPorUnaBombaDePistonesAxiales"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind070SustituciónDeBombaDeAltaPresiónPorUnaBombaDePistonesAxiales.pdf"
