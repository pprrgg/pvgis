...
@router.post('/Ind280anexoii')
def Ind280anexoiiCálculoDelRendimientoTotalDeLaBomba(data: dict):
    ...
    ss.nombre = "Ind280anexoiiCálculoDelRendimientoTotalDeLaBomba"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind280anexoiiCálculoDelRendimientoTotalDeLaBomba.pdf"
