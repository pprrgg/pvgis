...
@router.post('/Ind030anexoii')
def Ind030anexoiiTablas(data: dict):
    ...
    ss.nombre = "Ind030anexoiiTablas"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind030anexoiiTablas.pdf"
