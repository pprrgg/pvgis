...
@router.post('/Ind050anexoii')
def Ind050anexoiiTiempoAnualDeFuncionamientoDelSistemaDe(data: dict):
    ...
    ss.nombre = "Ind050anexoiiTiempoAnualDeFuncionamientoDelSistemaDe"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind050anexoiiTiempoAnualDeFuncionamientoDelSistemaDe.pdf"
