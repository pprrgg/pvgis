...
@router.post('/Ind060anexoiii')
def Ind060anexoiiiEquivalenciasClimasCteZonasClimáticas(data: dict):
    ...
    ss.nombre = "Ind060anexoiiiEquivalenciasClimasCteZonasClimáticas"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind060anexoiiiEquivalenciasClimasCteZonasClimáticas.pdf"
