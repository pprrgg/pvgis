...
@router.post('/Ind220')
def Ind220AumentoDeLaPresiónDeEvaporaciónPorCambioATecnologíaMásEficienteEnUnaInstalaciónFrigoríficaCentralizadaOCompacta(data: dict):
    ...
    ss.nombre = "Ind220AumentoDeLaPresiónDeEvaporaciónPorCambioATecnologíaMásEficienteEnUnaInstalaciónFrigoríficaCentralizadaOCompacta"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind220AumentoDeLaPresiónDeEvaporaciónPorCambioATecnologíaMásEficienteEnUnaInstalaciónFrigoríficaCentralizadaOCompacta.pdf"
