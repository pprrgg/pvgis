...
@router.post('/Ind020anexoii')
def Ind020anexoiiTablas(data: dict):
    ...
    ss.nombre = "Ind020anexoiiTablas"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind020anexoiiTablas.pdf"
