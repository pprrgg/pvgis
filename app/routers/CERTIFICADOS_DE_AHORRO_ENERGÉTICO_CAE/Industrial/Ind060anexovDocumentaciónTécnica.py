...
@router.post('/Ind060anexov')
def Ind060anexovDocumentaciónTécnica(data: dict):
    ...
    ss.nombre = "Ind060anexovDocumentaciónTécnica"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind060anexovDocumentaciónTécnica.pdf"
