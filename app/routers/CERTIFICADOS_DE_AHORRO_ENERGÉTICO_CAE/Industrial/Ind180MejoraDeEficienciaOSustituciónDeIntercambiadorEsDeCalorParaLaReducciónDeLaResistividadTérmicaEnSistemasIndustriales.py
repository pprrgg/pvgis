...
@router.post('/Ind180')
def Ind180MejoraDeEficienciaOSustituciónDeIntercambiadorEsDeCalorParaLaReducciónDeLaResistividadTérmicaEnSistemasIndustriales(data: dict):
    ...
    ss.nombre = "Ind180MejoraDeEficienciaOSustituciónDeIntercambiadorEsDeCalorParaLaReducciónDeLaResistividadTérmicaEnSistemasIndustriales"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind180MejoraDeEficienciaOSustituciónDeIntercambiadorEsDeCalorParaLaReducciónDeLaResistividadTérmicaEnSistemasIndustriales.pdf"
