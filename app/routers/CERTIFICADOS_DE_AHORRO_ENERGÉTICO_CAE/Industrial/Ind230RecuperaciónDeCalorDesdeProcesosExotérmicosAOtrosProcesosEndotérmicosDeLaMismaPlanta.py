...
@router.post('/Ind230')
def Ind230RecuperaciónDeCalorDesdeProcesosExotérmicosAOtrosProcesosEndotérmicosDeLaMismaPlanta(data: dict):
    ...
    ss.nombre = "Ind230RecuperaciónDeCalorDesdeProcesosExotérmicosAOtrosProcesosEndotérmicosDeLaMismaPlanta"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind230RecuperaciónDeCalorDesdeProcesosExotérmicosAOtrosProcesosEndotérmicosDeLaMismaPlanta.pdf"
