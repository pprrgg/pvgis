...
@router.post('/Ind040anexoii')
def Ind040anexoiiDeclaraciónFórmulasParaRealizarLa(data: dict):
    ...
    ss.nombre = "Ind040anexoiiDeclaraciónFórmulasParaRealizarLa"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind040anexoiiDeclaraciónFórmulasParaRealizarLa.pdf"
