...
@router.post('/Ind060anexoiv')
def Ind060anexoivFórmulasParaObtenerLosCoeficientesDe(data: dict):
    ...
    ss.nombre = "Ind060anexoivFórmulasParaObtenerLosCoeficientesDe"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind060anexoivFórmulasParaObtenerLosCoeficientesDe.pdf"
