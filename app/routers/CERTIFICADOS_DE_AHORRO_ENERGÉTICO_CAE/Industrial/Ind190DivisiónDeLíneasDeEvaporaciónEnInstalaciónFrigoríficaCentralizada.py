...
@router.post('/Ind190')
def Ind190DivisiónDeLíneasDeEvaporaciónEnInstalaciónFrigoríficaCentralizada(data: dict):
    ...
    ss.nombre = "Ind190DivisiónDeLíneasDeEvaporaciónEnInstalaciónFrigoríficaCentralizada"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind190DivisiónDeLíneasDeEvaporaciónEnInstalaciónFrigoríficaCentralizada.pdf"
