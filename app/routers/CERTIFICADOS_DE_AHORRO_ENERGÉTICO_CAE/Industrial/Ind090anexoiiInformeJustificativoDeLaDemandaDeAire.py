...
@router.post('/Ind090anexoii')
def Ind090anexoiiInformeJustificativoDeLaDemandaDeAire(data: dict):
    ...
    ss.nombre = "Ind090anexoiiInformeJustificativoDeLaDemandaDeAire"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind090anexoiiInformeJustificativoDeLaDemandaDeAire.pdf"
