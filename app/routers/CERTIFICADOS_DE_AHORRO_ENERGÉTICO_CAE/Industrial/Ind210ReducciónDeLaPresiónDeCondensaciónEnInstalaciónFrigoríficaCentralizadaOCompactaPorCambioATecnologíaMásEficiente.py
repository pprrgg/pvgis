...
@router.post('/Ind210')
def Ind210ReducciónDeLaPresiónDeCondensaciónEnInstalaciónFrigoríficaCentralizadaOCompactaPorCambioATecnologíaMásEficiente(data: dict):
    ...
    ss.nombre = "Ind210ReducciónDeLaPresiónDeCondensaciónEnInstalaciónFrigoríficaCentralizadaOCompactaPorCambioATecnologíaMásEficiente"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind210ReducciónDeLaPresiónDeCondensaciónEnInstalaciónFrigoríficaCentralizadaOCompactaPorCambioATecnologíaMásEficiente.pdf"
