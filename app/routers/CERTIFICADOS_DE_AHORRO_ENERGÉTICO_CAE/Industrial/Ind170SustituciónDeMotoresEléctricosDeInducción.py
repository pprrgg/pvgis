...
@router.post('/Ind170')
def Ind170SustituciónDeMotoresEléctricosDeInducción(data: dict):
    ...
    ss.nombre = "Ind170SustituciónDeMotoresEléctricosDeInducción"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind170SustituciónDeMotoresEléctricosDeInducción.pdf"
