...
@router.post('/Ind040anexoiv')
def Ind040anexoivRendimientoDeCalderaSustituida(data: dict):
    ...
    ss.nombre = "Ind040anexoivRendimientoDeCalderaSustituida"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind040anexoivRendimientoDeCalderaSustituida.pdf"
