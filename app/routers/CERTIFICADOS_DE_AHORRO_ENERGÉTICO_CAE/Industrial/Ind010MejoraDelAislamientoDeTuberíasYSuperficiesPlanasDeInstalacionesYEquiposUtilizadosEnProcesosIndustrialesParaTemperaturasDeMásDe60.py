...
@router.post('/Ind010')
def Ind010MejoraDelAislamientoDeTuberíasYSuperficiesPlanasDeInstalacionesYEquiposUtilizadosEnProcesosIndustrialesParaTemperaturasDeMásDe60(data: dict):
    ...
    ss.nombre = "Ind010MejoraDelAislamientoDeTuberíasYSuperficiesPlanasDeInstalacionesYEquiposUtilizadosEnProcesosIndustrialesParaTemperaturasDeMásDe60"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind010MejoraDelAislamientoDeTuberíasYSuperficiesPlanasDeInstalacionesYEquiposUtilizadosEnProcesosIndustrialesParaTemperaturasDeMásDe60.pdf"
