...
@router.post('/Ind040')
def Ind040SustituciónDeCalderaDeCombustiónExistentePorBombaDeCalor(data: dict):
    ...
    ss.nombre = "Ind040SustituciónDeCalderaDeCombustiónExistentePorBombaDeCalor"
    ss.path = f"app/routers/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind040SustituciónDeCalderaDeCombustiónExistentePorBombaDeCalor.pdf"
