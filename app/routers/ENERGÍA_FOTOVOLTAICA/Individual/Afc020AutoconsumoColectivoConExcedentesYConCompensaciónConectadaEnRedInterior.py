...
\begin{Form}
	...
	ss.t02tablaEnergíaconsumida

	ss.t02tablaPotenciacontratada
    ...
    class texfile:
        ...
        def replaceLatex(ruta_tex, ss):
            ...
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                with open(f"{ss.nombre}.tex", "w", encoding="utf-8") as archivo:
...
def Afc020AutoconsumoColectivoConExcedentesYConCompensaciónConectadaEnRedInterior(
    data: dict,
):
    ...
    with open(f"{ss.nombre}.pdf", "wb") as f:
...
if __name__ == "__main__":
    ...
    Afc020AutoconsumoColectivoConExcedentesYConCompensaciónConectadaEnRedInterior(data)
