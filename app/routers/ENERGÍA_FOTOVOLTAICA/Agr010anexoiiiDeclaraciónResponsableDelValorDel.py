...
class formulario:
    ...
    class formulario:
        ...
        def rellenoFormulario00(pdf_buffer, ss):
            print(f"\n {100*'+'}{ __class__.__name__}.{sys._getframe().f_code.co_name}")
...
@router.post('/Agr010anexoiii')
def CAEs_Agrario_Agr010anexoiii(data: dict):
    ...
    ss = SimpleNamespace()
    # Ejemplo de uso
    ss.nombre = "Agr010anexoiiiDeclaraciónResponsableDelValorDel"
    ss.path = f"app/routers/CAEs/Agrario/Agr010anexoiiiDeclaraciónResponsableDelValorDel.pdf"
...
if __name__ == "__main__":
    ...
    CAEs_Agrario_Agr010anexoiii(data)
