...
for root, _, files in os.walk(base_dir):
    for file in files:
        if (
            file.endswith(".jsx") and "Anexo" not in file
        ):  # Filtrar solo archivos JSX que contengan 'Anexo'
...
exclusiones = ["AAA", "EFICIENCIA", "BT", "FOTOVOL"]

catalogo = [
    item
    for item in catalogo
    if not any(palabra in item["grupo"].upper() for palabra in exclusiones)
]
# !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! ojo a los filtros
# !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! ojo a los filtros
# !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! ojo a los filtros
